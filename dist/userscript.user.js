...
(function () {
    ...
    function hydrateImageLoadingState(root) {
      root.querySelectorAll(".full-image").forEach((img) => {
        const image = img;
    ...
    function getImageSource(container) {
      const image = container.querySelector(".full-image");
    ...
    function useMessageImageViewer(messageRef, content) {
      y$1(() => {
        const messageElement = messageRef.current;
        if (!messageElement) return;
        const containers = Array.from(
          messageElement.querySelectorAll(".image-container")
        );
        const handlers = [];
        for (const container of containers) {
          const handler = (event) => {
            ...
            const timelineContainers = Array.from(
              scope.querySelectorAll(".image-container")
            );
            ...
            const messageIds = Array.from(
              scope.querySelectorAll(".chat-message[data-db-id]")
    ...
    function useCollapsibleMessage(textContentRef, contentKey, isDeleted, isSticker) {
    ...
    function TextFormatterLayer({ editorRef, inputControllerRef }) {
      ...
      const formatterContent = /* @__PURE__ */ _$3(
        ...
        /* @__PURE__ */ _$3("div", { class: "formatter-row main-buttons" }, /* @__PURE__ */ _$3("button", { type: "button", class: "formatter-btn", title: "防剧透 (Mask)", onClick: () => applyBBCode("mask"), dangerouslySetInnerHTML: { __html: iconSpoiler } }), /* @__PURE__ */ _$3("div", { class: "formatter-divider" }), /* @__PURE__ */ _$3("button", { type: "button", class: "formatter-btn", title: "加粗", onClick: () => applyBBCode("b"), dangerouslySetInnerHTML: { __html: iconBold } }), /* @__PURE__ */ _$3("button", { type: "button", class: "formatter-btn", title: "斜体", onClick: () => applyBBCode("i"), dangerouslySetInnerHTML: { __html: iconItalic } }), /* @__PURE__ */ _$3("button", { type: "button", class: "formatter-btn", title: "下划线", onClick: () => applyBBCode("u"), dangerouslySetInnerHTML: { __html: iconUnderline } }), /* @__PURE__ */ _$3("button", { type: "button", class: "formatter-btn", title: "删除线", onClick: () => applyBBCode("s"), dangerouslySetInnerHTML: { __html: iconStrike } }), /* @__PURE__ */ _$3("button", { type: "button", class: "formatter-btn", title: "等宽代码", onClick: () => applyBBCode("code"), dangerouslySetInnerHTML: { __html: iconCode } }), /* @__PURE__ */ _$3("div", { class: "formatter-divider" }), /* @__PURE__ */ _$3("button", { type: "button", class: "formatter-btn", title: "添加链接", onClick: () => switchMode(true), dangerouslySetInnerHTML: { __html: iconLink } })),
        /* @__PURE__ */ _$3("div", { class: "formatter-row formatter-link-input-wrapper" }, /* @__PURE__ */ _$3("button", { type: "button", class: "formatter-btn", title: "返回", onClick: () => switchMode(false), dangerouslySetInnerHTML: { __html: iconBack } }), /* @__PURE__ */ _$3("div", { class: "formatter-divider" }), /* @__PURE__ */ _$3("input", { ref: linkInputRef, type: "text", class: "formatter-link-input", placeholder: "输入链接 URL...", autoComplete: "off", onKeyDown: handleLinkKeyDown }), /* @__PURE__ */ _$3("div", { class: "formatter-divider" }), /* @__PURE__ */ _$3("button", { type: "button", class: "formatter-btn", title: "确认", onClick: applyLink, dangerouslySetInnerHTML: { __html: iconCheck } }))
      );
    ...
    function MediaPreview({ previewMedia, onRemoveMedia }) {
      ...
      ), /* @__PURE__ */ _$3("div", { class: "video-play-overlay" })), /* @__PURE__ */ _$3(
        "button",
        {
...
${content}`;
    ...
    function FloatingPortal({ children }) {
      ...
      y$1(() => {
        const host = hostRef.current;
        if (host) {
          G(/* @__PURE__ */ _$3(k$1, null, children), host);
        }
      }, [children]);
      return null;
    }
    function ChatInput() {
      ...
      return /* @__PURE__ */ _$3("div", { ref: containerRef, class: "chat-input-container" }, /* @__PURE__ */ _$3(
      ...
      ), /* @__PURE__ */ _$3(TextFormatter, { editorRef, inputControllerRef }), /* @__PURE__ */ _$3(MentionCompleter, { editorRef, inputControllerRef }), /* @__PURE__ */ _$3(TypingIndicator, null), /* @__PURE__ */ _$3(
        "div",
        {
        ...
        (replyingTo.value || editingMessage.value) && /* @__PURE__ */ _$3("div", { id: "dollars-reply-preview", class: `reply-preview visible` }, /* @__PURE__ */ _$3("div", { class: "reply-bar" }), replyingTo.value && /* @__PURE__ */ _$3(k$1, null, /* @__PURE__ */ _$3(
          "img",
          {
            class: "reply-avatar",
        ...
        (isRecording || voiceDraft) && /* @__PURE__ */ _$3("div", { class: "voice-preview-container visible" }, isRecording ? /* @__PURE__ */ _$3(k$1, null, /* @__PURE__ */ _$3("div", { class: "voice-recording-dot", "aria-hidden": "true" }), /* @__PURE__ */ _$3("span", { class: "voice-preview-title" }, "正在录音"), /* @__PURE__ */ _$3("span", { class: "voice-preview-duration" }, formatVoiceDuration(recordingDuration)), /* @__PURE__ */ _$3("button", { type: "button", class: "voice-preview-action primary", onClick: stopRecording }, "停止"), /* @__PURE__ */ _$3("button", { type: "button", class: "voice-preview-action", onClick: cancelVoice }, "取消")) : voiceDraft && /* @__PURE__ */ _$3(k$1, null, /* @__PURE__ */ _$3("audio", { class: "voice-preview-audio", controls: true, preload: "metadata", src: voiceDraft.url }), /* @__PURE__ */ _$3("span", { class: "voice-preview-duration" }, formatVoiceDuration(voiceDraft.duration)), /* @__PURE__ */ _$3("button", { type: "button", class: "voice-preview-action", onClick: cancelVoice, title: "删除语音" }, "删除"))),
        /* @__PURE__ */ _$3("div", { class: "input-wrapper" }, /* @__PURE__ */ _$3(
        ...
        )), /* @__PURE__ */ _$3("div", { class: "input-actions" }, /* @__PURE__ */ _$3("div", { class: "dollars-attach-menu-wrapper" }, /* @__PURE__ */ _$3(
          "button",
          {
            ref: attachButtonRef,
        ...
        )), isAttachMenuOpen && attachMenuPosition && /* @__PURE__ */ _$3(FloatingPortal, null, /* @__PURE__ */ _$3(
          "div",
          {
            ref: attachMenuRef,
          ...
          /* @__PURE__ */ _$3(
            ...
            /* @__PURE__ */ _$3("span", { class: "context-icon", "aria-hidden": "true", dangerouslySetInnerHTML: { __html: iconPhoto } }),
            /* @__PURE__ */ _$3("span", null, "媒体")
          ),
          /* @__PURE__ */ _$3(
            "button",
            {
            ...
            /* @__PURE__ */ _$3("span", { class: "context-icon", "aria-hidden": "true", dangerouslySetInnerHTML: { __html: iconFile } }),
            /* @__PURE__ */ _$3("span", null, "文件")
          ),
          /* @__PURE__ */ _$3(
            "button",
            {
            ...
            /* @__PURE__ */ _$3("span", { class: "context-icon", "aria-hidden": "true", dangerouslySetInnerHTML: { __html: iconMic } }),
            /* @__PURE__ */ _$3("span", null, isRecording ? "停止录音" : voiceDraft ? "重录语音" : "语音")
          )
        )), /* @__PURE__ */ _$3(
          "input",
          {
    ...
    function GalleryPanel({ onClose }) {
      ...
      return /* @__PURE__ */ _$3("div", { class: "gallery-container" }, /* @__PURE__ */ _$3("div", { class: "gallery-header" }, /* @__PURE__ */ _$3("span", { class: "gallery-title" }, "相册"), /* @__PURE__ */ _$3(
        ...
        return /* @__PURE__ */ _$3(
          ...
          ), /* @__PURE__ */ _$3("div", { class: "video-overlay" })) : /* @__PURE__ */ _$3(
            "img",
            {
              src: item.thumbnailUrl || item.url,
              alt: "",
        ...
        /* @__PURE__ */ _$3("div", { class: "uprofile-content" }, profile && /* @__PURE__ */ _$3("div", { class: "uprofile-body" }, /* @__PURE__ */ _$3("div", { class: "uprofile-name-section" }, /* @__PURE__ */ _$3("div", { class: "uprofile-nickname" }, profile?.nickname ?? userId, isActive && /* @__PURE__ */ _$3("span", { class: "uprofile-status-dot active", "aria-label": "在线", role: "img" })), /* @__PURE__ */ _$3("div", { class: "uprofile-username" }, "@", profile?.username ?? userId), lastActiveText && !isActive && /* @__PURE__ */ _$3("div", { class: "uprofile-last-active" }, "最近活跃 ", lastActiveText)), profile?.stats && /* @__PURE__ */ _$3("div", { class: "uprofile-stats-row" }, /* @__PURE__ */ _$3("div", { class: "uprofile-stat" }, /* @__PURE__ */ _$3("span", { class: "uprofile-stat-num" }, profile.stats.message_count.toLocaleString()), /* @__PURE__ */ _$3("span", { class: "uprofile-stat-label" }, "条消息")), /* @__PURE__ */ _$3("div", { class: "uprofile-stat-divider" }), /* @__PURE__ */ _$3("div", { class: "uprofile-stat" }, /* @__PURE__ */ _$3("span", { class: "uprofile-stat-num" }, profile.stats.average_messages_per_day.toFixed(1)), /* @__PURE__ */ _$3("span", { class: "uprofile-stat-label" }, "条/天"))), profile && /* @__PURE__ */ _$3("div", { class: "uprofile-actions" }, /* @__PURE__ */ _$3("button", { class: "uprofile-action-btn", onClick: handleHistory }, /* @__PURE__ */ _$3("span", { "aria-hidden": "true", dangerouslySetInnerHTML: { __html: iconHistory } }), "搜索发言"), /* @__PURE__ */ _$3("button", { class: "uprofile-action-btn", onClick: handleHomepage }, /* @__PURE__ */ _$3("span", { "aria-hidden": "true", dangerouslySetInnerHTML: { __html: iconHome } }), "主页")), (profile?.sign || profile?.stats?.first_message_time) && /* @__PURE__ */ _$3("div", { class: "uprofile-info-section" }, profile.sign && /* @__PURE__ */ _$3("div", { class: "uprofile-info-row" }, /* @__PURE__ */ _$3("span", { class: "context-icon", "aria-hidden": "true", dangerouslySetInnerHTML: { __html: iconPen } }), /* @__PURE__ */ _$3("div", { class: "uprofile-info-content" }, /* @__PURE__ */ _$3("div", { class: "uprofile-info-label" }, "个性签名"), /* @__PURE__ */ _$3("div", { class: "uprofile-info-value uprofile-sign-value" }, profile.sign))), profile.stats?.first_message_time && /* @__PURE__ */ _$3("div", { class: "uprofile-info-row" }, /* @__PURE__ */ _$3("span", { class: "context-icon", "aria-hidden": "true", dangerouslySetInnerHTML: { __html: iconCalendar } }), /* @__PURE__ */ _$3("div", { class: "uprofile-info-content" }, /* @__PURE__ */ _$3("div", { class: "uprofile-info-label" }, "首次发言"), /* @__PURE__ */ _$3("div", { class: "uprofile-info-value" }, formatDate(new Date(profile.stats.first_message_time).getTime() / 1e3, "full"))))), !mediaLoading && media.length > 0 && /* @__PURE__ */ _$3("div", { class: "uprofile-media-section" }, /* @__PURE__ */ _$3("div", { class: "uprofile-media-header", onClick: handleMedia, style: { cursor: "pointer" } }, /* @__PURE__ */ _$3("span", null, "媒体"), /* @__PURE__ */ _$3("span", { style: { fontSize: "12px", color: "var(--primary-color)", marginLeft: "auto" } }, "查看全部 →")), /* @__PURE__ */ _$3("div", { class: "uprofile-media-grid" }, media.map((item) => {
          ...
          return /* @__PURE__ */ _$3(
            ...
            item.type === "video" ? /* @__PURE__ */ _$3(
              ...
              /* @__PURE__ */ _$3("div", { class: "uprofile-media-video-badge", "aria-hidden": "true" })
            ) : /* @__PURE__ */ _$3(
              "img",
              {
                src: item.thumbnailUrl,
    ...
    class ErrorBoundary extends x {
      ...
      render() {
        if (this.state.hasError) {
          return /* @__PURE__ */ _$3("div", { class: "error-fallback" }, /* @__PURE__ */ _$3("div", { class: "error-fallback-icon" }, "😢"), /* @__PURE__ */ _$3("div", null, "加载出错了"), /* @__PURE__ */ _$3(
            "button",
            {
    ...
    function LightboxViewer() {
      ...
      return /* @__PURE__ */ _$3(
        ...
        /* @__PURE__ */ _$3("button", { class: "lb-close", onClick: close, "aria-label": "Close" }),
        (canNavigatePrevious || canNavigateNext) && /* @__PURE__ */ _$3("div", { class: "lb-counter" }, index + 1, " / ", total),
        canNavigatePrevious && /* @__PURE__ */ _$3("button", { class: "lb-nav lb-prev", onClick: () => navigate(-1), "aria-label": "Previous" }),
        canNavigateNext && /* @__PURE__ */ _$3("button", { class: "lb-nav lb-next", onClick: () => navigate(1), "aria-label": "Next" }),
    ...
    const cssContent = `:root{--dollars-z-index-base: 90;--dollars-z-index-smiley: 99;--dollars-z-index-context: 95;--dollars-z-index-overlay: 110;--dollars-z-index-modal: 2000;--dollars-bg: #fff;--dollars-bg-hover: rgba(0, 0, 0, .04);--dollars-border: rgba(0, 0, 0, .08);--dollars-shadow: rgba(0, 0, 0, .1);--dollars-bg-pattern: none;--dollars-bg-pattern-url: url(https://lsky.ry.mk/i/2026/01/03/background.svg);--dollars-text: #333;--dollars-text-secondary: #666;--dollars-text-placeholder: #999;--dollars-icon-color: #555;--dollars-icon-color-secondary: #888;--dollars-icon-search: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>');--dollars-icon-maximize: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"/></svg>');--dollars-icon-restore: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3"/></svg>');--dollars-icon-close: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>');--dollars-icon-reply: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 14l-4 -4l4 -4" /><path d="M5 10h11a4 4 0 1 1 0 8h-1" /></svg>');--dollars-icon-emoji: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 7m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v9a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z" /><path d="M16 3l-4 4l-4 -4" /></svg>');--dollars-icon-attach: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 7l-6.5 6.5a1.5 1.5 0 0 0 3 3l6.5 -6.5a3 3 0 0 0 -6 -6l-6.5 6.5a4.5 4.5 0 0 0 9 9l6.5 -6.5" /></svg>');--dollars-icon-back: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>');--dollars-icon-resize: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none"><path d="M10 2L2 10" stroke="white" stroke-width="2" stroke-linecap="round"/><path d="M14 6L6 14" stroke="white" stroke-width="2" stroke-linecap="round"/></svg>');--dollars-icon-settings: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10.325 4.317c.426 -1.756 2.924 -1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543 -.94 3.31 .826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756 .426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543 -.826 3.31 -2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756 -2.924 1.756 -3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543 .94 -3.31 -.826 -2.37 -2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756 -.426 -1.756 -2.924 0 -3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94 -1.543 .826 -3.31 2.37 -2.37c1 .608 2.296 .07 2.572 -1.065z" /><circle cx="12" cy="12" r="3" /></svg>');--dollars-bubble-tail: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11 20"><path fill="white" d="M3 3h6v17c-.193-2.84-.876-5.767-2.05-8.782C6.046 8.893 4.504 6.733 2.325 4.738A1 1 0 013 3z"/></svg>');--dollars-color-online: #4CAF50;--dollars-color-danger: #ef4444;--dollars-glass-border: rgba(255, 255, 255, .3);--dollars-glass-highlight: rgba(255, 255, 255, .3);--dollars-glass-bg: rgba(255, 255, 255, .55);--dollars-glass-blur: blur(16px) saturate(1.6) brightness(1.03);--dollars-glass-shadow: 0 8px 32px 0 rgba(31, 38, 135, .12), 0 2px 16px 0 rgba(31, 38, 135, .06), inset 0 1px 0 0 rgba(255, 255, 255, .5), inset 0 -1px 0 0 rgba(255, 255, 255, .2);--dollars-glass-border-color: rgba(255, 255, 255, .4)}#dollars-chat-window.visible{--dollars-bg-pattern: var(--dollars-bg-pattern-url)}html[data-theme=dark]{--dollars-bg: #1a1a1a;--dollars-bg-hover: rgba(255, 255, 255, .08);--dollars-border: rgba(255, 255, 255, .12);--dollars-shadow: rgba(0, 0, 0, .3);--dollars-text: #e0e0e0;--dollars-text-secondary: #999;--dollars-text-placeholder: #666;--dollars-icon-color: #bbb;--dollars-icon-color-secondary: #bbb;--dollars-glass-border: rgba(255, 255, 255, .1);--dollars-glass-highlight: rgba(255, 255, 255, .1);--dollars-glass-bg: rgba(30, 30, 30, .65);--dollars-glass-blur: blur(16px) saturate(1.6) brightness(1.1);--dollars-glass-shadow: 0 8px 32px 0 rgba(0, 0, 0, .3), inset 0 1px 0 0 rgba(255, 255, 255, .1), inset 0 -1px 0 0 rgba(255, 255, 255, .05);--dollars-glass-border-color: rgba(255, 255, 255, .12)}#dollars-chat-root.disable-blur{--dollars-glass-blur: none !important;--dollars-glass-bg: rgba(255, 255, 255, .95)}html[data-theme=dark] #dollars-chat-root.disable-blur{--dollars-glass-bg: rgba(30, 30, 30, .95)}#dollars-chat-root *::-webkit-scrollbar{width:5px;height:5px}#dollars-chat-root *::-webkit-scrollbar-track{background:transparent}#dollars-chat-root *::-webkit-scrollbar-thumb{background:color-mix(in srgb,var(--primary-color),transparent 75%);border-radius:10px}#dollars-chat-root *::-webkit-scrollbar-thumb:hover{background:color-mix(in srgb,var(--primary-color),transparent 50%)}#dollars-chat-root *{box-sizing:border-box;scrollbar-width:thin;scrollbar-color:color-mix(in srgb,var(--primary-color),transparent 75%) transparent}#dollars-chat-root{color:var(--dollars-text)}#dollars-chat-window{position:fixed;bottom:80px;right:20px;width:400px;height:550px;z-index:var(--dollars-z-index-base);display:flex;flex-direction:column;border-radius:15px;background:#ffffffd9;box-shadow:0 10px 28px #00000040;border:1px solid rgba(255,255,255,.1);background-clip:padding-box;overflow:hidden;opacity:0;pointer-events:none;transform:translateY(20px) scale(.9);transition:opacity .3s ease-out,transform .4s cubic-bezier(.16,1,.3,1)}#dollars-chat-window.visible{opacity:1;pointer-events:auto;transform:translateY(0) scale(1)}html[data-theme=dark] #dollars-chat-window{background:#1e1e1ee6;box-shadow:0 10px 28px #00000080}.error-fallback{padding:20px;text-align:center;color:var(--dollars-text-secondary, #888)}.error-fallback-icon{font-size:24px;margin-bottom:10px}.error-fallback button{margin-top:10px;padding:8px 16px;border:0;border-radius:4px;background:var(--primary-color, #f09199);color:#fff;cursor:pointer}#dollars-chat-window.maximized{inset:10px!important;width:auto!important;height:auto!important;max-width:none!important;max-height:none!important;border-radius:12px;transform:none!important}#dollars-chat-window.mobile{top:4vh!important;left:0!important;right:0!important;bottom:auto!important;width:95vw!important;height:92vh!important;max-width:600px;margin-left:auto!important;margin-right:auto!important;border-radius:20px}#dollars-chat-window.mobile.maximized{inset:0!important;width:100vw!important;height:100vh!important;height:100dvh!important;max-width:none!important;margin-left:0!important;margin-right:0!important;border-radius:0;z-index:98!important}#dollars-chat-window.mobile.visible{transform:translateY(0) scale(1)}#dollars-content-panes{display:flex;flex:1;min-height:0;overflow:hidden;position:relative}#dollars-sidebar{width:25%;height:100%;max-width:320px;display:flex;flex-direction:column;flex-shrink:0;border-right:none;box-shadow:inset -1px 0 #00000008;background-color:var(--dollars-bg)}#dollars-sidebar-search-container{padding:48px 8px 8px;border-bottom:1px solid var(--dollars-border);flex-shrink:0}#dollars-sidebar-search-input{display:flex;align-items:center;position:relative;border-radius:100px;border:1px solid var(--dollars-border);background-color:var(--dollars-bg);transition:.3s ease-in-out;padding:6px 12px;width:100%;box-sizing:border-box;font-size:13px;color:var(--dollars-text)}#dollars-sidebar-search-input:focus{outline:0;border-color:var(--primary-color);box-shadow:0 0 10px #f0919999}html[data-theme=dark] #dollars-sidebar-search-input{background-color:#3a3a3a}#dollars-sidebar-search-input::placeholder{color:var(--dollars-text-placeholder)}#dollars-conversation-list{flex-grow:1;overflow-y:auto;overscroll-behavior:contain;padding:4px}.conversation-item{display:flex;align-items:center;padding:5px 10px;gap:12px;cursor:pointer;position:relative;border-radius:15px;transition:background-color .2s,box-shadow .2s}.conversation-item:hover{background-color:var(--dollars-bg-hover)}.conversation-item.active{background:color-mix(in srgb,var(--primary-color),#ffffff 30%);color:#fff}html[data-theme=dark] .conversation-item.active{background:color-mix(in srgb,var(--primary-color),#180518 60%)}.conversation-item.active .dollars-conv-last-message,.conversation-item.active .dollars-conv-nickname,.conversation-item.active .dollars-conv-timestamp{color:#fff;text-shadow:0 1px 2px rgba(0,0,0,.1)}.conversation-item .avatar{width:46px;height:46px;border-radius:50%;flex-shrink:0;object-fit:cover;background-color:#f3f3f3}html[data-theme=dark] .conversation-item .avatar{background-color:#444}.conversation-item .dollars-conv-content{flex-grow:1;overflow:hidden}.conversation-item .dollars-conv-title{display:flex;justify-content:space-between;align-items:center;font-weight:700;font-size:13px}.conversation-item .dollars-conv-nickname{color:var(--dollars-text);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.conversation-item .dollars-conv-timestamp{font-size:11px;color:var(--dollars-text-secondary);flex-shrink:0;margin-left:8px}.conversation-item .dollars-conv-last-message{font-size:12px;color:var(--dollars-text-secondary);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin-top:2px}.conversation-item .unread-badge{position:absolute;right:10px;top:50%;transform:translateY(-50%);background-color:var(--primary-color);color:#fff;font-size:10px;font-weight:700;padding:2px 6px;border-radius:10px;min-width:16px;text-align:center}#dollars-chat-window.is-narrow #dollars-sidebar{width:100%;max-width:none;transition:transform .3s cubic-bezier(.4,0,.2,1)}#dollars-chat-window.is-narrow.mobile-chat-active #dollars-sidebar{transform:translate(-100%)}#dollars-chat-window.is-narrow #dollars-main-chat{position:absolute;top:0;left:0;width:100%;height:100%;transform:translate(100%);transition:transform .3s cubic-bezier(.4,0,.2,1)}#dollars-chat-window.is-narrow.mobile-chat-active #dollars-main-chat{transform:translate(0)}#dollars-chat-window.is-narrow #dollars-content-panes{overflow:hidden}#dollars-main-chat{display:flex;flex-direction:column;flex:1;min-height:0;overflow:hidden;position:relative;background-color:var(--dollars-bg);isolation:isolate;z-index:0}#dollars-main-chat:before{content:"";position:absolute;inset:0;z-index:-1;pointer-events:none;will-change:opacity;opacity:0;transition:opacity .3s ease}#dollars-chat-root[data-bg-mode=transparent] #dollars-main-chat:before{display:none!important}#dollars-chat-root[data-bg-mode=tint] #dollars-main-chat:before{background-image:var(--dollars-bg-pattern),linear-gradient(160deg,color-mix(in srgb,var(--primary-color),#a0c4ff 50%),color-mix(in srgb,var(--primary-color),#ffffff 50%),color-mix(in srgb,var(--primary-color),#ffc6ff 50%));background-repeat:repeat,no-repeat;background-position:center,center;background-size:400px,cover;background-blend-mode:overlay,normal;opacity:.65}#dollars-chat-root[data-bg-mode=lines] #dollars-main-chat:before{background-image:none;background-color:color-mix(in srgb,var(--primary-color),#ffffff 94%);opacity:.2}#dollars-chat-root[data-bg-mode=lines] #dollars-main-chat:after{content:"";position:absolute;inset:0;background-color:color-mix(in srgb,var(--primary-color),#ffffff 70%);-webkit-mask-image:var(--dollars-bg-pattern);mask-image:var(--dollars-bg-pattern);-webkit-mask-repeat:repeat;mask-repeat:repeat;-webkit-mask-size:400px;opacity:.7;z-index:-1;pointer-events:none}html[data-theme=dark] #dollars-chat-root[data-bg-mode=lines] #dollars-main-chat:after{opacity:.1}html[data-theme=dark] #dollars-chat-root[data-bg-mode=lines] #dollars-main-chat:before{background-image:none!important;background-color:transparent!important;-webkit-mask-image:none!important;mask-image:none!important;opacity:.25}html[data-theme=dark] #dollars-chat-root[data-bg-mode=tint] #dollars-main-chat:before{background-image:var(--dollars-bg-pattern),linear-gradient(160deg,color-mix(in srgb,var(--primary-color),#a0c4ff 50%),color-mix(in srgb,var(--primary-color),#ffffff 50%),color-mix(in srgb,var(--primary-color),#ffc6ff 50%));background-repeat:repeat,no-repeat;background-position:center,center;background-size:400px,cover;background-blend-mode:overlay,normal;-webkit-mask-image:none;mask-image:none;opacity:.3}.chat-header{background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);border-bottom:none;box-shadow:0 1px #00000005;display:flex;align-items:center;justify-content:space-between;padding:2px 15px;cursor:move;touch-action:none;flex-shrink:0;position:absolute;top:0;left:0;right:0;width:100%;height:40px;box-sizing:border-box;z-index:10002}html[data-theme=dark] .chat-header{background:var(--dollars-bg);border-bottom:none;box-shadow:0 1px #ffffff05}.chat-header .title-wrapper{flex-grow:1;display:flex;flex-direction:row;align-items:center;justify-content:flex-start;min-width:0;padding:0 4px;gap:8px;pointer-events:none}.chat-header-left-pane{width:25%;max-width:320px;flex-shrink:0;display:flex;align-items:center;padding-left:5px;gap:4px;margin-right:8px}#dollars-chat-window.is-narrow .chat-header-left-pane{width:auto;max-width:none}.header-chat-icon{width:30px;height:30px;border-radius:50%;object-fit:cover;flex-shrink:0;box-shadow:0 2px 4px #0000001a}.header-text-column{display:flex;flex-direction:column;gap:0;min-width:0;justify-content:center}.chat-header .title,.header-main-title{font-size:13px;font-weight:700;color:var(--dollars-text);letter-spacing:.2px;line-height:1.2}.chat-header .online-status{font-size:10px;color:var(--dollars-text-secondary);display:flex;align-items:center;gap:3px;opacity:.85;line-height:1.2}.chat-header .online-dot{width:6px;height:6px;background-color:var(--dollars-color-online);border-radius:50%;flex-shrink:0}.chat-header .header-buttons{display:flex;align-items:center;gap:5px}.chat-header .header-btn{width:24px;height:24px;border:none;background:transparent;border-radius:4px;cursor:pointer;display:flex;align-items:center;justify-content:center;color:var(--dollars-text-secondary);transition:background-color .2s;background-repeat:no-repeat;background-position:center;background-size:18px}.chat-header .header-btn:hover{background-color:#0000000d}html[data-theme=dark] .chat-header .header-btn:hover{background-color:#ffffff14}#dollars-search-btn,#dollars-maximize-btn,.chat-header .close-btn{background-color:var(--dollars-icon-color);-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;-webkit-mask-size:18px;mask-size:18px}#dollars-search-btn{-webkit-mask-image:var(--dollars-icon-search);mask-image:var(--dollars-icon-search)}#dollars-maximize-btn{-webkit-mask-image:var(--dollars-icon-maximize);mask-image:var(--dollars-icon-maximize)}#dollars-chat-window.maximized #dollars-maximize-btn{-webkit-mask-image:var(--dollars-icon-restore);mask-image:var(--dollars-icon-restore)}.chat-header .close-btn{-webkit-mask-image:var(--dollars-icon-close);mask-image:var(--dollars-icon-close)}.chat-body{contain:layout style paint;flex-grow:1;overflow-y:scroll;overflow-x:hidden;padding:50px 10px 80px;display:flex;flex-direction:column;position:relative;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;min-height:0;overflow-anchor:auto;background:transparent}.chat-body.loading .chat-list{opacity:0;transition:opacity .3s}.chat-body.context-loading .chat-list{opacity:0!important;transition:opacity .05s ease}.chat-list{display:flex;flex-direction:column;contain:layout style;transition:opacity .3s ease}.chat-message{position:relative;overflow:visible!important;display:flex;gap:8px;margin-bottom:12px;align-items:flex-start;opacity:1;transform:translateY(0) scale(1);transition:transform .4s cubic-bezier(.19,1,.22,1),opacity .3s ease-out;will-change:transform,opacity;transform-origin:center bottom}.chat-message.self{flex-direction:row-reverse}.chat-message.self .message-content{align-items:flex-end}.chat-message.pending{opacity:.7}.chat-message.pending .bubble{animation:pending-pulse 1.5s ease-in-out infinite}@keyframes pending-pulse{0%,to{opacity:.7}50%{opacity:1}}.chat-message.failed{opacity:.9}.chat-message.failed .bubble{border:1px solid rgba(239,68,68,.5);position:relative}.chat-message.failed .bubble:after{content:"\\53d1\\9001\\5931\\8d25\\ff0c\\70b9\\51fb\\91cd\\8bd5";position:absolute;bottom:-18px;right:0;font-size:11px;color:var(--dollars-color-danger);opacity:0;transition:opacity .2s;white-space:nowrap}.chat-message.failed:hover .bubble:after,.chat-message.failed:active .bubble:after{opacity:1}.chat-message.is-grouped-with-next{margin-bottom:2px}.chat-message.is-grouped-with-prev .avatar{visibility:hidden;height:0!important;margin:0!important;border:none!important}.chat-message .nickname{display:none!important}.chat-message .avatar{width:32px;height:32px;border-radius:50%;cursor:pointer;flex-shrink:0;object-fit:cover;background-color:#f3f3f3;transition:box-shadow .3s;-webkit-touch-callout:none;user-select:none}html[data-theme=dark] .chat-message .avatar{background-color:#444}.chat-message:after{content:"";position:absolute;width:8px;height:8px;background-color:var(--dollars-color-online);border:2px solid var(--dollars-bg);border-radius:50%;z-index:5;top:23px;left:23px;pointer-events:none;box-shadow:0 1px 2px #00000026;opacity:0;transform:scale(0);transition:transform .4s cubic-bezier(.34,1.56,.64,1),opacity .3s ease}.chat-message:has(.avatar.online):after{opacity:1;transform:scale(1)}.chat-message.self:after{left:auto;right:-2px}.chat-message.is-grouped-with-prev:after{opacity:0!important;transform:scale(0)!important}.chat-message .message-content{max-width:75%;display:flex;flex-direction:column;align-items:flex-start}.chat-list.focus-mode .chat-message:not(.message-highlight){filter:blur(4px);opacity:.6;transition:filter .3s ease,opacity .3s ease}.chat-message.message-highlight{position:relative;z-index:10;transform:scale(1.02);transition:transform .3s cubic-bezier(.34,1.56,.64,1)}.chat-message.message-highlight .bubble{box-shadow:0 0 20px rgba(var(--primary-rgb),.4)}.chat-message .bubble{display:flex;flex-direction:column;align-items:flex-start;padding:6px 10px;border-radius:0 12px 12px;word-wrap:break-word;overflow-wrap:anywhere;background-color:#fff;box-shadow:0 1px 2px #10232f26;color:var(--dollars-text);font-size:14px;max-width:min(40dvh,100%);position:relative;transition:background .3s ease}html[data-theme=dark] .chat-message .bubble{background-color:#212121}.chat-message.self .bubble{border-radius:12px 0 12px 12px;background:color-mix(in srgb,var(--primary-color),#ffffff 80%)}html[data-theme=dark] .chat-message.self .bubble{background-color:color-mix(in srgb,var(--primary-color),#180518 60%)}.chat-message:not(.self).is-grouped-with-prev .bubble{border-top-left-radius:4px!important}.chat-message.self.is-grouped-with-prev .bubble{border-top-right-radius:4px!important}.bubble.sticker-mode{background:transparent!important;box-shadow:none!important;padding:0!important;border:none!important}.bubble-nickname{display:block;width:100%;font-size:12px;margin-bottom:4px;line-height:1.2;user-select:none;color:var(--nick-color, var(--primary-color))}html[data-theme=dark] .bubble-nickname{color:color-mix(in srgb,var(--nick-color, var(--primary-color)),#fff 60%)!important}.chat-message.self .bubble-nickname{display:none}.chat-message .swipe-reply-indicator{position:absolute;left:100%;top:50%;transform:translateY(-50%) scale(.5);margin-left:10px;opacity:0;width:32px;height:32px;background-color:var(--dollars-icon-color-secondary);-webkit-mask-image:var(--dollars-icon-reply);mask-image:var(--dollars-icon-reply);-webkit-mask-size:24px;mask-size:24px;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;transition:transform .2s cubic-bezier(.2,.8,.2,1),opacity .2s ease;pointer-events:none}.chat-message.is-grouped-with-prev .bubble-nickname{display:none}.bubble.sticker-mode .bubble-nickname{display:none!important}.bubble-timestamp{font-size:10px;opacity:.58;user-select:none;cursor:default;color:var(--dollars-text-secondary);line-height:1.2;white-space:nowrap;pointer-events:none;max-width:100%}.text-content{display:block;width:100%;line-height:1.6}.text-content>:first-child{margin-top:0}.text-content>:last-child{margin-bottom:0}html[data-theme=dark] .bubble-timestamp{color:color-mix(in srgb,var(--primary-color),#fff 60%)}.bubble.has-trailing-timestamp{display:flow-root}.bubble.has-trailing-timestamp .text-content{display:inline;width:auto}.bubble.has-trailing-timestamp .bubble-timestamp.is-trailing{float:right;margin-left:8px;margin-top:8px;text-align:right}.bubble.has-stacked-timestamp .bubble-timestamp.is-stacked{align-self:flex-end;margin-top:6px;text-align:right}.bubble.has-stacked-timestamp .expand-toggle-btn+.bubble-timestamp.is-stacked{margin-top:4px}.bubble.sticker-mode .bubble-timestamp.is-overlay{position:absolute;right:6px;bottom:6px;background:#0006;backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);color:#ffffffe6;padding:2px 6px;border-radius:999px;font-size:10px;line-height:1.2;opacity:0;transition:opacity .2s ease;text-shadow:0 1px 2px rgba(0,0,0,.3);z-index:10}@media(hover:hover)and (pointer:fine){.chat-message:hover .bubble.sticker-mode .bubble-timestamp.is-overlay,.chat-message:focus-within .bubble.sticker-mode .bubble-timestamp.is-overlay{opacity:1}}@media(hover:none),(pointer:coarse){.bubble.sticker-mode .bubble-timestamp.is-overlay{opacity:1}}.chat-message.failed .bubble.sticker-mode .bubble-timestamp.is-overlay{opacity:1}.chat-message .bubble:before{content:"";position:absolute;top:0;width:11px;height:20px;pointer-events:none;z-index:1;background-color:currentColor;-webkit-mask:var(--dollars-bubble-tail) center / contain no-repeat;mask:var(--dollars-bubble-tail) center / contain no-repeat}.chat-message:not(.self) .bubble:before{left:-9px;top:-3px;color:#fff}html[data-theme=dark] .chat-message:not(.self) .bubble:before{color:#212121}.chat-message.self .bubble:before{right:-9px;top:-3px;transform:scaleX(-1);color:color-mix(in srgb,var(--primary-color),#ffffff 80%)}html[data-theme=dark] .chat-message.self .bubble:before{color:color-mix(in srgb,var(--primary-color),#180518 60%)!important}.chat-message.is-grouped-with-prev .bubble:before{display:none}.bubble.sticker-mode:before{display:none}.bubble .text-content.deleted{font-style:italic!important;color:var(--dollars-text-secondary)!important}.bubble .text-content.is-collapsed{display:block!important;max-height:var(--collapse-max-height, 300px);overflow:hidden;position:relative;-webkit-mask-image:linear-gradient(to bottom,black 70%,transparent 100%);mask-image:linear-gradient(to bottom,black 70%,transparent 100%)}.expand-toggle-btn{display:inline-block;align-self:center;max-width:100%;background:color-mix(in srgb,var(--primary-color),transparent 90%);border:0;border-radius:999px;color:var(--primary-color);font-size:12px;font-weight:600;line-height:1.2;cursor:pointer;padding:4px 10px;margin-top:8px;text-align:center;transition:background-color .2s ease}.expand-toggle-btn:hover{background:color-mix(in srgb,var(--primary-color),transparent 84%);text-decoration:none}.expand-toggle-btn:focus-visible{outline:2px solid color-mix(in srgb,var(--primary-color),#fff 15%);outline-offset:2px}.bubble a{color:#0084b4!important}.bubble a:hover{text-decoration:underline}.bubble img.smiley{display:inline-block;width:21px;height:21px;margin:0 1px;vertical-align:text-bottom;image-rendering:pixelated}.bubble img.custom-emoji{max-width:150px;max-height:150px;border-radius:8px}.bubble img.smiley-musume,.bubble img.smiley-blake{width:60px;height:60px;image-rendering:auto;vertical-align:bottom}.bubble.sticker-mode .custom-emoji{max-width:120px;max-height:120px;margin:2px 0;display:block}.bubble.sticker-mode .smiley-musume,.bubble.sticker-mode .smiley-blake{width:100px;height:100px;display:block;margin:2px 0}.bubble .message-media-block{max-width:100%;margin:10px 0 6px}.bubble .message-media-block:first-child{margin-top:2px}.bubble .message-media-block:last-child{margin-bottom:0}.bubble .message-media-block{display:flex;align-items:flex-start}.chat-message.self .bubble .message-media-block{justify-content:flex-end}.bubble .message-media-grid{display:grid;gap:3px;max-width:320px;border-radius:8px;overflow:hidden}.bubble .message-media-grid[style*="--media-count: 2"],.bubble .message-media-grid[style*="--media-count: 3"],.bubble .message-media-grid[style*="--media-count: 4"]{grid-template-columns:repeat(2,1fr)}.bubble .message-media-grid[style*="--media-count: 5"],.bubble .message-media-grid[style*="--media-count: 6"],.bubble .message-media-grid[style*="--media-count: 7"],.bubble .message-media-grid[style*="--media-count: 8"],.bubble .message-media-grid[style*="--media-count: 9"]{grid-template-columns:repeat(3,1fr)}.bubble .message-media-grid .image-container{width:100%!important;max-height:none;border-radius:0;aspect-ratio:1 / 1}.bubble .message-media-grid .image-container .full-image{object-fit:cover}.bubble .image-container{position:relative;display:grid;overflow:hidden;border-radius:5px;cursor:pointer;max-height:250px;background:color-mix(in srgb,var(--dollars-bg-hover),transparent 8%)}.bubble .image-container .full-image{width:100%;height:100%;object-fit:contain;opacity:0;grid-area:1/1;transition:opacity .3s ease-out;z-index:2}.bubble .image-container .full-image.is-loaded{opacity:1}.bubble .image-container .full-image.load-failed{width:100%;height:100%;object-fit:cover;background-color:var(--dollars-bg-hover);border-radius:14px}.bubble .image-container.image-placeholder{cursor:default}.bubble .image-container.image-placeholder .image-load-hint{position:absolute;right:10px;bottom:10px;z-index:3;background:#00000080;color:#fff;padding:6px 12px;border-radius:16px;font-size:12px;white-space:nowrap;pointer-events:none;backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);transition:opacity .2s ease}.bubble .image-container.image-placeholder:hover .image-load-hint{background:#000000b3}.bubble .image-container.image-masked .full-image{filter:blur(24px) brightness(.45);transform:scale(1.08)}.bubble .image-container.image-masked{cursor:default}.bubble .image-container.image-masked .image-load-hint{background:#000000ad}.bubble .chat-file-link{display:inline-flex;align-items:center;gap:6px;margin:4px 0;padding:2px 0;font-size:13px;font-weight:600;line-height:1.5;max-width:100%;color:var(--primary-color)!important;text-decoration:none!important;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.bubble .chat-file-link:before{content:"\\9644\\4ef6";flex-shrink:0;padding:1px 6px;border-radius:999px;font-size:11px;font-weight:700;color:var(--primary-color);background:color-mix(in srgb,var(--primary-color),transparent 88%)}.bubble .chat-file-link:hover{text-decoration:underline!important}.chat-quote{padding:6px 8px;border-left:3px solid var(--primary-color);background:linear-gradient(#ffffffe6,#ffffffe6),var(--primary-color);border-radius:5px;margin-bottom:8px;display:flex;align-items:center;gap:8px;cursor:pointer;max-width:100%;width:100%;box-sizing:border-box;transition:opacity .2s,transform .15s ease,background .2s}html[data-theme=dark] .chat-quote{background:linear-gradient(#000000bf,#000000bf),var(--primary-color)}.chat-quote:hover{opacity:.9;transform:scale(1.01)}#dollars-toast{position:absolute;bottom:80px;left:50%;transform:translate(-50%) translateY(12px);background:var(--dollars-glass-bg);color:var(--dollars-text);font-size:13px;font-weight:700;line-height:1.4;padding:8px 18px;border-radius:999px;border:1px solid var(--dollars-glass-border-color);white-space:nowrap;pointer-events:none;z-index:200;opacity:0;transition:opacity .22s ease,transform .22s cubic-bezier(.34,1.56,.64,1);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);box-shadow:var(--dollars-glass-shadow)}#dollars-toast.dollars-toast-visible{opacity:1;transform:translate(-50%) translateY(0)}.quote-avatar{width:14px;height:14px;border-radius:50%;object-fit:cover;flex-shrink:0;margin-right:4px}.quote-thumbnail{width:36px;height:36px;border-radius:4px;object-fit:cover;margin-bottom:2px;display:block}.quote-thumbnail.image-masked{filter:blur(6px) brightness(.7)}.quote-nickname{font-weight:700;color:var(--primary-color);font-size:12px}.quote-text-wrapper{min-width:0;flex:1}.quote-content{font-size:12px;color:var(--dollars-text);opacity:.8;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;overflow-wrap:break-word}.chat-input-container{position:absolute;bottom:12px;left:12px;right:12px;width:auto;z-index:100;transition:transform .2s ease}.chat-input-container:hover{transform:translateY(-2px)}.chat-input-area{position:relative;background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);border:none;box-shadow:var(--dollars-glass-shadow),inset 0 0 0 1px var(--dollars-glass-border-color, rgba(255, 255, 255, .35));border-radius:24px;padding:6px 8px;transition:box-shadow .2s ease}.chat-input-area.drag-over{box-shadow:var(--dollars-glass-shadow),inset 0 0 0 2px color-mix(in srgb,var(--primary-color),transparent 25%)}.chat-input-area.drag-over:after{content:"\\677e\\5f00\\4ee5\\4e0a\\4f20";position:absolute;inset:6px;z-index:5;display:flex;align-items:center;justify-content:center;border:1px dashed color-mix(in srgb,var(--primary-color),transparent 20%);border-radius:18px;background:color-mix(in srgb,var(--dollars-glass-bg),var(--primary-color) 12%);color:var(--primary-color);font-size:14px;font-weight:600;pointer-events:none;backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur)}.reply-preview{display:flex;align-items:center;gap:8px;padding:0 8px 4px;margin:0 4px 4px;border-bottom:1px solid var(--dollars-glass-border);height:0;opacity:0;overflow:hidden;transition:height .2s ease-out,opacity .2s ease-out}.reply-preview.visible{height:42px;opacity:1}.reply-preview .reply-bar{width:3px;height:70%;background-color:var(--primary-color);border-radius:2px}.reply-preview .reply-avatar{width:24px;height:24px;border-radius:50%}.reply-preview .reply-info{flex:1;min-width:0;font-size:12px;line-height:1.4}.reply-preview .reply-user{font-weight:700;color:var(--primary-color)}.reply-preview .reaction-item .num{color:var(--dollars-text-secondary)}@keyframes pop{0%{transform:scale(1)}50%{transform:scale(1.4)}to{transform:scale(1)}}.reaction-item.live_selected .emoji{animation:pop .3s cubic-bezier(.175,.885,.32,1.275)}.reply-preview .reply-text{color:var(--dollars-text-secondary);display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.reply-preview .reply-cancel-btn{background:none;border:none;cursor:pointer;color:var(--dollars-text-secondary);font-size:20px;padding:0}.image-preview-container{display:flex;align-items:center;gap:8px;padding:0 8px;margin:0 4px;border-bottom:1px solid var(--dollars-glass-border);height:0;opacity:0;overflow-x:auto;overflow-y:hidden;transition:height .2s ease-out,opacity .2s ease-out,padding .2s ease-out,margin .2s ease-out;scrollbar-width:none}.image-preview-container.visible{height:80px;opacity:1;padding-bottom:8px;margin-bottom:4px;margin-top:4px}.image-preview-container::-webkit-scrollbar{display:none}.image-preview-item{position:relative;flex-shrink:0;width:64px;height:64px;border-radius:8px;overflow:hidden;border:1px solid var(--dollars-border);background:var(--dollars-bg);box-shadow:0 2px 4px #0000001a}.preview-image{width:100%;height:100%;object-fit:cover;transition:transform .2s}.image-preview-item:hover .preview-image{transform:scale(1.05)}.preview-remove-btn{position:absolute;top:2px;right:2px;width:18px;height:18px;background:#00000080;border-radius:50%;color:#fff;display:flex;align-items:center;justify-content:center;font-size:14px;cursor:pointer;border:none;backdrop-filter:blur(2px);transition:background .2s,transform .1s;padding:0;line-height:1}.preview-remove-btn:hover{background:#f44336e6;transform:scale(1.1)}.video-preview-item{position:relative}.preview-video{width:100%;height:100%;object-fit:cover;transition:transform .2s}.video-preview-item:hover .preview-video{transform:scale(1.05)}.video-play-overlay{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:32px;height:32px;background:#0009;border-radius:50%;display:flex;align-items:center;justify-content:center;pointer-events:none;backdrop-filter:blur(2px)}.video-play-overlay:before{content:"";width:0;height:0;margin-left:2px;border-top:7px solid transparent;border-bottom:7px solid transparent;border-left:11px solid #fff}.voice-preview-container{display:flex;align-items:center;gap:8px;padding:0 8px;margin:0 4px;border-bottom:1px solid var(--dollars-glass-border);height:0;opacity:0;overflow:hidden;transition:height .2s ease-out,opacity .2s ease-out,padding .2s ease-out,margin .2s ease-out}.voice-preview-container.visible{height:50px;opacity:1;padding-bottom:8px;margin-bottom:4px;margin-top:4px}.voice-recording-dot{width:10px;height:10px;flex:0 0 auto;border-radius:50%;background:var(--dollars-color-danger);box-shadow:0 0 0 4px color-mix(in srgb,var(--dollars-color-danger),transparent 80%);animation:dollars-voice-pulse 1s ease-in-out infinite}.voice-preview-title{font-size:13px;color:var(--dollars-text)}.voice-preview-duration{margin-left:auto;font-size:12px;color:var(--dollars-text-secondary);font-variant-numeric:tabular-nums}.voice-preview-audio{flex:1;min-width:0;height:32px}.voice-preview-action{border:1px solid var(--dollars-border);border-radius:999px;background:var(--dollars-glass-bg);color:var(--dollars-text);cursor:pointer;font-size:12px;padding:4px 10px}.voice-preview-action.primary{border-color:color-mix(in srgb,var(--primary-color),transparent 50%);color:var(--primary-color)}@keyframes dollars-voice-pulse{0%,to{transform:scale(1);opacity:1}50%{transform:scale(.75);opacity:.65}}.input-wrapper{display:flex;align-items:center;gap:6px;position:relative}.dollars-input-wrapper{flex-grow:1;display:flex;align-items:stretch;border-radius:18px;min-width:0;background-color:#ffffff40;border:none;box-shadow:inset 0 1px 2px #00000008;transition:all .2s ease;backdrop-filter:blur(5px);padding-left:0;position:relative}html[data-theme=dark] .dollars-input-wrapper{background-color:#0000004d}.dollars-input-wrapper:focus-within{background-color:#ffffff80;border-color:var(--primary-color);box-shadow:inset 0 1px 3px #0000001a,0 0 8px color-mix(in srgb,var(--primary-color),transparent 40%)!important}html[data-theme=dark] .dollars-input-wrapper:focus-within{background-color:#00000080}.chat-textarea{flex:1;border:none;background:transparent;border-radius:18px;padding:8px 14px;resize:none;font-size:14px;line-height:1.4;height:38px;max-height:150px;color:var(--dollars-text);outline:none;font-family:inherit;box-sizing:border-box;width:100%;display:block;white-space:pre-wrap;word-break:break-word;overflow-wrap:anywhere;overflow-y:hidden}html[data-theme=dark] .chat-textarea{background:none!important}.chat-textarea:focus{outline:none;box-shadow:none!important}.chat-rich-editor{min-height:38px;caret-color:var(--dollars-text);line-height:1.5}.chat-rich-editor.is-overflowing{overflow-y:auto}.chat-rich-editor:empty:before{content:attr(data-placeholder);color:var(--dollars-text-placeholder);pointer-events:none}.chat-textarea-proxy{position:absolute;inset:0;opacity:0;pointer-events:none;resize:none}.chat-input-token{display:inline-flex;align-items:center;justify-content:center;vertical-align:middle;max-width:100%;user-select:all;margin-block:2px}.chat-input-token img,.chat-input-token .bmoji-image{display:block;pointer-events:none}.chat-input-token-smiley .chat-input-inline-smiley:not(.chat-input-inline-large),.chat-input-token-bmo .bmoji-image{image-rendering:pixelated}.chat-input-token-smiley .chat-input-inline-large,.chat-input-token-image .chat-input-inline-sticker{image-rendering:auto}.chat-input-inline-smiley{width:21px;height:21px}.chat-input-inline-large{width:60px;height:60px}.chat-input-inline-sticker{width:auto;height:60px;max-width:min(180px,100%);max-height:60px;border-radius:10px}.input-actions{display:flex;gap:4px}.action-btn{flex-shrink:0;width:38px;height:38px;border:none;border-radius:50%;background-color:transparent;cursor:pointer;display:flex;align-items:center;justify-content:center;color:var(--dollars-text-secondary);transition:all .2s cubic-bezier(.34,1.56,.64,1);background-repeat:no-repeat;background-position:center}.action-btn:hover{background-color:var(--dollars-glass-highlight);transform:scale(1.1)}.action-btn:active{transform:scale(.95)}.action-btn:disabled{cursor:not-allowed;opacity:.45;transform:none}.send-btn{width:38px;height:38px;border:none;background:var(--primary-color);background-image:url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.5"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4.698 4.034l16.302 7.966l-16.302 7.966a.503 .503 0 0 1 -.546 -.124a.555 .555 0 0 1 -.12 -.568l2.468 -7.274l-2.468 -7.274a.555 .555 0 0 1 .12 -.568a.503 .503 0 0 1 .546 -.124z" /><path d="M6.5 12h14.5" /></svg>');background-size:20px;background-repeat:no-repeat;background-position:center;border-radius:50%;cursor:pointer;display:flex;align-items:center;justify-content:center;color:#fff;transition:background-color .2s,filter .2s,box-shadow .2s,transform .15s ease;box-shadow:0 0 10px color-mix(in srgb,var(--primary-color),transparent 20%)}.send-btn:hover{filter:brightness(1.1);transform:scale(1.05)}.send-btn:disabled{background-color:#ccc;cursor:not-allowed;filter:none;box-shadow:none}#dollars-smiles-floating{--item-size: 32px;--icon-size: 21px;--item-hover-bg: rgba(255, 255, 255, .3);--item-hover-scale: 1.1;--transition-speed: .2s;--panel-height: 320px;--border-color: var(--dollars-border);position:absolute;bottom:calc(100% + 5px);z-index:var(--dollars-z-index-smiley);height:var(--panel-height);width:100%;left:0;display:flex;flex-direction:column;border:1px solid var(--dollars-glass-border-color);border-radius:18px;background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);box-shadow:var(--dollars-glass-shadow);box-sizing:border-box;overflow:hidden;opacity:0;transform:translateY(10px) scale(.95);transition:opacity .2s,transform .2s;pointer-events:none;transform-origin:bottom left}html[data-theme=dark] #dollars-smiles-floating{--item-hover-bg: rgba(255, 255, 255, .1)}@keyframes dollars-panel-slide-up{0%{opacity:0;transform:translateY(15px) scale(.95)}to{opacity:1;transform:translateY(0) scale(1)}}#dollars-smiles-floating.open{opacity:1;transform:translateY(0) scale(1);pointer-events:auto;animation:dollars-panel-slide-up .25s cubic-bezier(.34,1.56,.64,1)}#dollars-smiles-tabs{display:flex;flex-shrink:0;padding:4px;border-bottom:1px solid rgba(255,255,255,.2);background-color:transparent;overflow-x:auto;overflow-y:hidden;scrollbar-width:none}#dollars-smiles-tabs::-webkit-scrollbar{display:none}.smiley-tab-btn{padding:4px 12px;border:1px solid transparent;border-radius:15px;background:none;cursor:pointer;color:var(--primary-color);font-size:13px;flex-shrink:0;transition:background-color var(--transition-speed),color var(--transition-speed);image-rendering:pixelated}.smiley-tab-btn:hover{background-color:var(--item-hover-bg)}.smiley-tab-btn.active{background-color:transparent;color:var(--primary-color);border-color:var(--dollars-border);font-weight:700}#dollars-smiles-content{padding:8px;overflow-y:auto;display:flex;flex-wrap:wrap;gap:6px;justify-content:flex-start;overscroll-behavior:contain}#dollars-smiles-content.grouped-content{display:block;padding:10px}.smiley-group-section+.smiley-group-section{margin-top:12px;padding-top:10px;border-top:1px solid rgba(127,127,127,.18)}.smiley-group-title{margin:0 0 8px 2px;color:var(--dollars-text-secondary);font-size:12px;font-weight:700;line-height:1.3}.smiley-group-grid{display:flex;flex-wrap:wrap;gap:6px}.smiley-item{list-style:none;margin:0;padding:0;width:var(--item-size);height:var(--item-size);display:flex;align-items:center;justify-content:center;position:relative}.smiley-item a{display:flex;align-items:center;justify-content:center;width:100%;height:100%;border-radius:6px;background-repeat:no-repeat;background-position:center;background-size:var(--icon-size) var(--icon-size);font-size:0;transition:background-color var(--transition-speed),transform calc(var(--transition-speed) / 2);image-rendering:pixelated}#dollars-smiles-floating .bmo,#dollars-reaction-picker-floating .bmo{vertical-align:middle}.smiley-item a:hover{background-color:var(--item-hover-bg);transform:scale(var(--item-hover-scale))}.smiley-item.favorite-item{width:64px;height:64px;border-radius:8px}.smiley-item.favorite-item a{background-size:contain;background-color:#00000008}html[data-theme=dark] .smiley-item.favorite-item a{background-color:#ffffff0d}.smiley-item.favorite-item .remove-favorite-btn{position:absolute;top:-4px;right:-4px;width:16px;height:16px;background:#00000080;color:#fff;border-radius:50%;border:none;font-size:12px;line-height:1;display:flex;align-items:center;justify-content:center;cursor:pointer;opacity:0;transition:opacity .2s}.smiley-item.favorite-item:hover .remove-favorite-btn{opacity:1}#dollars-smiles-floating.large-smiley-mode{--item-size: 56px;--icon-size: 48px}#dollars-smiles-floating.large-smiley-mode .smiley-item a{image-rendering:auto}#dollars-context-menu{position:fixed;z-index:var(--dollars-z-index-overlay);background:transparent;border:none;box-shadow:none;min-width:unset;opacity:0;transform:scale(.95);pointer-events:none;transition:transform .15s cubic-bezier(.2,.8,.2,1),opacity .15s ease-out}html[data-theme=dark] #dollars-context-menu{background:transparent;box-shadow:none}#dollars-context-menu.visible{opacity:1;transform:scale(1);pointer-events:auto}#dollars-context-menu.has-items-wrapper{padding:0;display:flex;flex-direction:column;gap:8px;align-items:flex-start}.context-menu-reactions{display:flex;align-items:center;padding:6px;gap:4px;background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);box-shadow:var(--dollars-glass-shadow);border:1px solid var(--dollars-glass-border-color);border-radius:40px}.context-menu-reactions .reaction-item{width:30px;height:30px;display:flex;align-items:center;justify-content:center;border-radius:50%;cursor:pointer;transition:transform .1s ease,background-color .15s ease;-webkit-touch-callout:none;user-select:none}.context-menu-reactions .reaction-item:hover{background-color:var(--dollars-bg-hover);transform:scale(1.15)}.context-menu-reactions .reaction-item:active{transform:scale(.95)}.context-menu-reactions .reaction-item img{width:20px;height:20px;display:block;image-rendering:pixelated}.context-menu-reactions .reaction-item .bmoji-image,.reaction-item .bmoji-image{width:18px!important;height:18px!important}.context-menu-reactions-more{width:30px;height:30px;display:flex;align-items:center;justify-content:center;border:none;background:none;border-radius:50%;cursor:pointer;color:var(--dollars-text-secondary);transition:background-color .15s ease,transform .1s ease;flex-shrink:0}.context-menu-reactions-more:hover{background-color:var(--dollars-bg-hover);transform:scale(1.1)}.context-menu-reactions-more:active{transform:scale(.95)}.context-menu-reactions-more svg{width:20px;height:20px;transition:transform .3s ease}.context-menu-reactions-more.expanded svg{transform:rotate(180deg)}.context-menu-items{padding:5px 0;min-width:160px;max-width:220px;background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);box-shadow:var(--dollars-glass-shadow);border:1px solid var(--dollars-glass-border-color);border-radius:18px;overflow:hidden}.context-menu-items button{display:flex;align-items:center;width:100%;padding:8px 12px;border:none;background:none;text-align:left;cursor:pointer;color:var(--dollars-text);font-size:14px;line-height:20px;transition:background-color .1s ease;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.context-menu-items button span:not(.context-icon){flex:1;overflow:hidden;text-overflow:ellipsis}.context-icon{width:20px;height:20px;margin-right:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;color:var(--dollars-text-secondary)}html[data-theme=dark] .context-icon{color:#aaa}.context-icon svg{width:20px;height:20px}.context-menu-items button.danger .context-icon{color:#f5222d}.context-menu-items button:hover{background-color:var(--dollars-bg-hover)}.context-menu-items button:disabled{cursor:not-allowed;opacity:.45}.context-menu-items button:disabled:hover{background:none}.context-menu-items button.danger{color:#f5222d}.context-menu-items button.image-action{display:none}#dollars-context-menu.image-mode .context-menu-items button.image-action{display:flex}#dollars-reaction-picker-floating{--item-size: 32px;--icon-size: 21px;--item-hover-bg: rgba(255, 255, 255, .3);--panel-height: 260px;position:fixed;z-index:calc(var(--dollars-z-index-overlay) + 1);height:var(--panel-height);display:flex;flex-direction:column;border:1px solid var(--dollars-glass-border-color);border-radius:18px;background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);box-shadow:var(--dollars-glass-shadow);overflow:hidden;opacity:0;transform:translateY(-5px) scale(.95);transition:opacity .15s ease,transform .15s cubic-bezier(.2,.8,.2,1);pointer-events:none}html[data-theme=dark] #dollars-reaction-picker-floating{--item-hover-bg: rgba(255, 255, 255, .1)}@keyframes dollars-picker-slide-down{0%{opacity:0;transform:translateY(-15px) scale(.95)}60%{transform:translateY(3px) scale(1.01)}to{opacity:1;transform:translateY(0) scale(1)}}#dollars-reaction-picker-floating.open{opacity:1;transform:translateY(0) scale(1);pointer-events:auto;animation:dollars-picker-slide-down .3s cubic-bezier(.34,1.56,.64,1)}.reaction-picker-tabs{display:flex;flex-shrink:0;padding:4px;border-bottom:1px solid rgba(255,255,255,.2);background-color:transparent;gap:2px}.reaction-picker-tab-btn{padding:4px 10px;border:1px solid transparent;border-radius:12px;background:none;cursor:pointer;color:var(--dollars-text-secondary);font-size:13px;transition:background-color .15s,color .15s;image-rendering:pixelated}html[data-theme=dark] .reaction-picker-tab-btn{color:#aaa}.reaction-picker-tab-btn:hover{background-color:var(--item-hover-bg)}html[data-theme=dark] .reaction-picker-tab-btn:hover{background-color:#444}.reaction-picker-tab-btn.active{background-color:var(--dollars-bg);color:var(--dollars-text);border-color:var(--dollars-border);font-weight:700}html[data-theme=dark] .reaction-picker-tab-btn.active{background-color:#3a3a3a;color:#eee;border-color:#555}.reaction-picker-content{padding:8px;overflow-y:auto;display:flex;flex-wrap:wrap;gap:6px;justify-content:flex-start;overscroll-behavior:contain}.reaction-picker-content .smiley-item{list-style:none;margin:0;padding:0;width:var(--item-size);height:var(--item-size);display:flex;align-items:center;justify-content:center;position:relative}.reaction-picker-content .smiley-item a{display:flex;align-items:center;justify-content:center;width:100%;height:100%;border-radius:6px;background-repeat:no-repeat;background-position:center;background-size:var(--icon-size) var(--icon-size);font-size:0;transition:background-color .15s,transform .1s;image-rendering:pixelated}.reaction-picker-content .smiley-item a:hover{background-color:var(--item-hover-bg);transform:scale(1.1)}.user-mention{color:var(--primary-color);font-weight:500}.user-mention:hover{text-decoration:underline}.chat-tag{color:var(--primary-color);cursor:pointer;margin-right:2px;display:inline-block}.chat-tag:hover{opacity:.8}#dollars-floating-date{position:absolute;top:55px;left:50%;transform:translate(-50%);z-index:10;pointer-events:none;opacity:0;transition:opacity .2s ease;background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);box-shadow:var(--dollars-glass-shadow);border:1px solid var(--dollars-glass-border-color);color:var(--primary-color);padding:4px 12px;border-radius:20px;font-size:12px;font-weight:700;text-shadow:none;white-space:nowrap}#dollars-floating-date.visible{opacity:1}#dollars-typing-indicator{position:absolute;top:-30px;left:10px;height:auto;background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);box-shadow:var(--dollars-glass-shadow);border:1px solid var(--dollars-glass-border-color);padding:4px 10px;border-radius:12px;font-size:12px;color:var(--dollars-text-secondary);font-style:italic;opacity:0;transition:opacity .2s,transform .2s;line-height:1.5;pointer-events:none;transform:translateY(5px);overflow:hidden;white-space:nowrap;text-overflow:ellipsis}#dollars-typing-indicator.visible{opacity:1;transform:translateY(0)}html[data-theme=dark] #dollars-typing-indicator{color:#fff}span.text_mask{background-color:#555}@media(max-width:768px){#dollars-chat-window{width:auto;max-width:calc(100vw - 20px);height:calc(100dvh - 60px);max-height:calc(100dvh - 60px);inset:auto 10px 30px}.chat-message{content-visibility:visible;contain-intrinsic-size:auto}.bubble .message-media-block{margin:8px 0 5px}}@media(prefers-reduced-motion:reduce){#dollars-chat-window,#dollars-chat-window .chat-header .close-btn,#dollars-chat-window .chat-message,#dollars-chat-window .send-btn{transition:none!important}}#dollars-emoji-btn{width:38px;height:38px;border:none;background-color:var(--dollars-icon-color);cursor:pointer;-webkit-mask-image:var(--dollars-icon-emoji);mask-image:var(--dollars-icon-emoji);-webkit-mask-size:23px;mask-size:23px;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;border-radius:50%}#dollars-attach-btn{width:38px;height:38px;border:none;background-color:var(--dollars-icon-color);cursor:pointer;-webkit-mask-image:var(--dollars-icon-attach);mask-image:var(--dollars-icon-attach);-webkit-mask-size:23px;mask-size:23px;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;border-radius:50%}#dollars-attach-btn.active{background-color:var(--dollars-icon-color)}.dollars-attach-menu-wrapper{position:relative;display:flex;align-items:center;width:38px;height:38px}.dollars-attach-menu{position:fixed;z-index:var(--dollars-z-index-overlay);transform-origin:bottom right;animation:dollars-panel-slide-up-right .25s cubic-bezier(.34,1.56,.64,1)}.dollars-attach-menu.context-menu-items{width:176px;min-width:176px}.dollars-attach-menu .context-icon{pointer-events:none}.dollars-attach-menu.closing{animation:dollars-slide-down-out .2s ease-out forwards;pointer-events:none}@keyframes dollars-panel-slide-up-right{0%{opacity:0;transform:translateY(15px) translate(8px) scale(.95)}to{opacity:1;transform:translateY(0) translate(0) scale(1)}}.chat-header .header-buttons,.header-buttons{margin-left:auto;display:flex;align-items:center;gap:5px}.header-btn{cursor:pointer;width:24px;height:24px;display:flex;align-items:center;justify-content:center;border-radius:4px;transition:background-color .2s ease,transform .15s ease;border:none;background:transparent}#dollars-back-btn,.dollars-back-btn{margin-right:0;background-color:var(--dollars-icon-color);-webkit-mask-image:var(--dollars-icon-back);mask-image:var(--dollars-icon-back);-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center}#dollars-resize-handle{position:absolute;top:0;left:0;width:20px;height:20px;cursor:nw-resize;z-index:10003;touch-action:none;background-color:var(--dollars-icon-color-secondary);-webkit-mask-image:var(--dollars-icon-resize);mask-image:var(--dollars-icon-resize);-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:5px 5px;mask-position:5px 5px;-webkit-mask-size:10px;mask-size:10px;opacity:.6;transition:opacity .2s ease}#dollars-resize-handle:hover{opacity:1}#dollars-resize-handle:after{display:none!important}#dollars-settings-btn-header{background-color:var(--dollars-icon-color);-webkit-mask-image:var(--dollars-icon-settings);mask-image:var(--dollars-icon-settings);-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center}#dollars-text-formatter{position:fixed;z-index:var(--dollars-z-index-context);background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);box-shadow:var(--dollars-glass-shadow);border:1px solid var(--dollars-glass-border-color);border-radius:50px;display:flex;flex-direction:column;padding:4px;opacity:0;transform:translateY(10px) scale(.95);pointer-events:none;transition:opacity .2s cubic-bezier(.2,.8,.2,1),transform .2s cubic-bezier(.2,.8,.2,1)}#dollars-text-formatter.visible{opacity:1;transform:translateY(0) scale(1);pointer-events:auto}.formatter-row{display:flex;align-items:center;gap:2px}.formatter-btn{width:32px;height:32px;display:flex;align-items:center;justify-content:center;border:none;background:transparent;border-radius:50px;cursor:pointer;color:var(--dollars-text);transition:background-color .15s,transform .1s,color .15s}.formatter-btn:hover{background-color:var(--dollars-bg-hover)}.formatter-btn.active{color:var(--primary-color)}.formatter-btn svg{width:18px;height:18px}.formatter-divider{width:1px;height:18px;background-color:var(--dollars-border);margin:0 4px}.formatter-link-input-wrapper{display:none;align-items:center;gap:4px;padding:0 2px}#dollars-text-formatter.link-mode .main-buttons{display:none}#dollars-text-formatter.link-mode .formatter-link-input-wrapper{display:flex}.formatter-link-input{background:transparent;border:none;color:var(--dollars-text);font-size:13px;width:150px;outline:none;padding:4px}.formatter-link-input::placeholder{color:var(--dollars-text-placeholder)}.nav-btn{width:40px;height:40px;border-radius:50%;border:1px solid var(--dollars-glass-border-color);background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);box-shadow:var(--dollars-glass-shadow);color:var(--primary-color);cursor:pointer;display:flex;align-items:center;justify-content:center;opacity:0;transform:scale(.8);transition:all .2s cubic-bezier(.34,1.56,.64,1);pointer-events:none}.nav-btn.visible{opacity:1;transform:scale(1);pointer-events:auto}.nav-btn:hover{background:var(--dollars-glass-bg);transform:scale(1.1);box-shadow:var(--dollars-glass-shadow),0 0 0 2px color-mix(in srgb,var(--primary-color),transparent 70%)}.nav-btn:active{transform:scale(.95)}.nav-btn:before{content:"";display:block;width:24px;height:24px;background:currentColor}#dollars-scroll-bottom-btn{position:absolute;bottom:80px;right:20px;z-index:95}#dollars-scroll-mention-btn{position:absolute;right:20px;z-index:95}#dollars-scroll-bottom-btn:before{width:15px;height:15px;border-right:3px solid currentColor;border-bottom:3px solid currentColor;background:transparent;transform:translateY(-3px) rotate(45deg)}#dollars-scroll-mention-btn:before{content:"@";width:auto;height:auto;background:transparent;font-size:23px;font-weight:700;line-height:1}.nav-btn-badge{position:absolute;top:-5px;right:-5px;min-width:18px;height:18px;border-radius:9px;background-color:var(--primary-color);color:#fff;font-size:11px;font-weight:700;line-height:18px;text-align:center;padding:0 5px;box-shadow:0 2px 5px #0003;z-index:31}#dollars-mention-list{position:absolute;bottom:calc(100% + 5px);left:0;width:100%;max-height:220px;overflow-y:auto;border-radius:18px;display:none;flex-direction:column;z-index:var(--dollars-z-index-smiley);background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);box-shadow:var(--dollars-glass-shadow);border:1px solid var(--dollars-glass-border-color);gap:4px;transition:bottom .2s ease}#dollars-mention-list.visible{display:flex;animation:dollars-slide-up .2s cubic-bezier(.2,.8,.2,1)}@keyframes dollars-slide-up{0%{opacity:0;transform:translateY(10px) scale(.98)}to{opacity:1;transform:translateY(0) scale(1)}}@keyframes dollars-item-slide-in{0%{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}}.mention-item{display:flex;align-items:center;padding:4px 8px;border-radius:15px;cursor:pointer;transition:background-color .2s;gap:8px;animation:dollars-item-slide-in .25s cubic-bezier(.2,.8,.2,1) backwards}.mention-item:nth-child(1){animation-delay:0ms}.mention-item:nth-child(2){animation-delay:30ms}.mention-item:nth-child(3){animation-delay:60ms}.mention-item:nth-child(4){animation-delay:90ms}.mention-item:nth-child(5){animation-delay:.12s}.mention-item:nth-child(6){animation-delay:.15s}.mention-item:hover,.mention-item.active{background-color:#ffffff4d}html[data-theme=dark] .mention-item:hover,html[data-theme=dark] .mention-item.active{background-color:#ffffff1a}.mention-item img{width:24px;height:24px;border-radius:50%;object-fit:cover;background-color:var(--dollars-bg);box-shadow:0 1px 3px #0000001a}.mention-item-info{display:flex;align-items:baseline;gap:6px;overflow:hidden;min-width:0;line-height:1.2}.mention-item-nick{font-size:12px;font-weight:700;color:var(--dollars-text);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.mention-item-user{font-size:10px;color:var(--dollars-text-secondary);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;opacity:.8}.dollars-preview-card{background-color:var(--dollars-bg);border:1px solid var(--dollars-border);border-radius:8px;padding:10px;display:flex;gap:12px;text-decoration:none!important;transition:all .2s;box-sizing:border-box;max-width:100%!important;height:100px;width:300px;overflow:hidden;position:relative;min-width:0}.dollars-preview-card .cover{width:80px;height:80px;flex-shrink:0;border-radius:6px;background-color:var(--dollars-bg);overflow:hidden;display:flex;align-items:center;justify-content:center}.dollars-preview-card .cover img{width:100%;height:100%;object-fit:cover;border-radius:0!important}.dollars-preview-card[data-entity-type=character] .cover img,.dollars-preview-card[data-entity-type=person] .cover img{object-fit:contain!important}.dollars-preview-card[data-entity-type=generic] .cover{background-color:var(--dollars-bg);border-radius:5px}.dollars-preview-card[data-entity-type=generic] .cover img{object-fit:cover}.dollars-preview-card .inner{flex:1;min-width:0;display:flex;flex-direction:column;justify-content:center;overflow:hidden}.dollars-preview-card .title{font-size:14px;font-weight:700;color:var(--dollars-text)!important;margin:0 0 4px;line-height:1.4;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.dollars-preview-card .info{font-size:12px;color:var(--dollars-text-secondary);margin:0;line-height:1.5;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.dollars-preview-card[data-entity-type=generic] .info{margin-top:4px;margin-bottom:0}.dollars-preview-card .rateInfo{margin-top:6px;font-size:11px;color:var(--dollars-text-placeholder);display:flex;align-items:center;gap:5px}@media(prefers-reduced-motion:reduce){.uprofile-action-btn,.uprofile-action-btn:active{transition:none;transform:none}.uprofile-info-row,.uprofile-media-item img,#dollars-user-profile-panel.narrow,#dollars-user-profile-panel.narrow.visible,#dollars-user-profile-panel.narrow.closing,#dollars-user-profile-panel.wide,#dollars-user-profile-panel.wide.visible,#dollars-user-profile-panel.wide.closing{transition:none}}#dollars-user-profile-panel{position:absolute;z-index:100;display:flex;flex-direction:column;background:var(--dollars-bg);overflow:hidden}#dollars-user-profile-panel.narrow{inset:0;transform:translate(100%);transition:transform .25s cubic-bezier(.2,.8,.2,1)}#dollars-user-profile-panel.narrow.visible{transform:translate(0)}#dollars-user-profile-panel.narrow.closing{transform:translate(100%)}#dollars-user-profile-panel.wide{inset:56px 16px 16px;z-index:101;border-radius:16px;border:1px solid var(--dollars-border);box-shadow:0 8px 40px -8px var(--dollars-shadow);opacity:0;transform:translateY(4px);transition:opacity .25s cubic-bezier(.2,.8,.2,1),transform .25s cubic-bezier(.2,.8,.2,1);pointer-events:none}#dollars-user-profile-panel.wide.visible{opacity:1;transform:translateY(0);pointer-events:auto}#dollars-user-profile-panel.wide.closing{opacity:0;transform:translateY(4px);pointer-events:none}.uprofile-card-header{display:flex;align-items:center;gap:8px;padding:8px 12px 8px 8px;flex-shrink:0;border-bottom:1px solid var(--dollars-border)}.uprofile-card-title{font-size:14px;font-weight:600;color:var(--dollars-text)}.uprofile-banner{height:120px;flex-shrink:0;background:linear-gradient(160deg,color-mix(in srgb,var(--primary-color),var(--dollars-bg) 30%),color-mix(in srgb,var(--primary-color),var(--dollars-bg) 60%),color-mix(in srgb,var(--primary-color),var(--dollars-bg) 30%));position:relative;display:flex;align-items:flex-end;justify-content:center}.uprofile-banner:before{content:"";position:absolute;inset:0;background-image:var(--dollars-bg-pattern-url);background-size:300px;opacity:.6;mix-blend-mode:overlay}html[data-theme=dark] .uprofile-banner:before{opacity:.2}.uprofile-avatar{width:88px;height:88px;border-radius:50%;border:3px solid var(--dollars-bg);background-color:var(--dollars-bg);object-fit:cover;box-shadow:0 4px 16px var(--dollars-shadow);position:relative;z-index:1;transform:translateY(44px);flex-shrink:0}.uprofile-content{flex:1;overflow-y:auto;padding:52px 20px 24px;display:flex;flex-direction:column;gap:16px}.uprofile-body{display:flex;flex-direction:column;gap:16px}.uprofile-name-section{display:flex;flex-direction:column;align-items:center;gap:2px}.uprofile-nickname{font-size:20px;font-weight:800;color:var(--dollars-text);line-height:1.3;word-break:break-word;text-align:center;display:flex;align-items:center;justify-content:center;gap:6px}.uprofile-status-dot{display:inline-block;width:9px;height:9px;border-radius:50%;background-color:var(--dollars-color-online);flex-shrink:0;box-shadow:0 0 0 2px var(--dollars-bg);position:relative}.uprofile-status-dot.active:after{content:none}.uprofile-username{font-size:13px;color:var(--dollars-text-secondary);font-family:monospace;text-align:center}.uprofile-last-active{font-size:12px;color:var(--dollars-text-placeholder);margin-top:2px}.uprofile-stats-row{display:flex;align-items:center;justify-content:center;gap:0;background:color-mix(in srgb,var(--primary-color),transparent 92%);border:1px solid color-mix(in srgb,var(--primary-color),transparent 80%);border-radius:12px;padding:10px 8px}.uprofile-stat{flex:1;display:flex;flex-direction:column;align-items:center;gap:2px}.uprofile-stat-num{font-size:17px;font-weight:700;color:var(--primary-color);line-height:1;letter-spacing:-.3px;display:inline-block}.uprofile-stat-label{font-size:11px;color:var(--dollars-text-placeholder);line-height:1}.uprofile-stat-divider{width:1px;height:28px;background:color-mix(in srgb,var(--primary-color),transparent 70%);flex-shrink:0}.uprofile-actions{display:flex;gap:8px}.uprofile-action-btn{flex:1;display:flex;align-items:center;justify-content:center;gap:6px;padding:10px 12px;border-radius:10px;background:var(--dollars-glass-bg);border:1px solid var(--dollars-border);color:var(--dollars-text);font-size:13px;cursor:pointer;transition:background-color .14s ease-out,color .14s ease-out,border-color .14s ease-out;white-space:nowrap}.uprofile-action-btn:hover{background:var(--primary-color);color:var(--dollars-bg);border-color:var(--primary-color)}.uprofile-action-btn:focus-visible{outline:2px solid var(--primary-color);outline-offset:2px}.uprofile-action-btn span{display:flex;align-items:center;flex-shrink:0}.uprofile-action-btn svg{width:16px;height:16px;stroke:currentColor}.uprofile-info-section{display:flex;flex-direction:column;border-top:1px solid var(--dollars-border);padding-top:12px}.uprofile-info-row{display:flex;align-items:flex-start;gap:12px;padding:10px 8px;border-radius:8px;transition:background-color .15s}.uprofile-info-row:hover{background:var(--dollars-bg-hover)}.uprofile-info-row+.uprofile-info-row{border-top:1px solid color-mix(in srgb,var(--dollars-border),transparent 50%)}.uprofile-info-content{flex:1;min-width:0}.uprofile-info-label{font-size:11px;color:var(--primary-color);opacity:.8;font-weight:500;margin-bottom:2px}.uprofile-info-value{font-size:13px;color:var(--dollars-text);line-height:1.5;word-break:break-word}.uprofile-sign-value{padding:4px 8px;border-left:2px solid color-mix(in srgb,var(--primary-color),transparent 40%);background:color-mix(in srgb,var(--primary-color),transparent 92%);border-radius:0 6px 6px 0;color:var(--dollars-text-secondary)}.uprofile-media-section{border-top:1px solid var(--dollars-border);padding-top:12px}.uprofile-media-header{display:flex;align-items:center;justify-content:space-between;margin-bottom:10px;padding:0 4px}.uprofile-media-header span{font-size:13px;font-weight:600;color:var(--dollars-text)}.uprofile-media-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:3px;border-radius:10px;overflow:hidden}.uprofile-media-item{position:relative;aspect-ratio:1;cursor:pointer;overflow:hidden;background:var(--dollars-border)}.uprofile-media-item img{width:100%;height:100%;object-fit:cover;transition:transform .16s ease-out}.uprofile-media-item:hover img{transform:scale(1.02)}.uprofile-media-video-btn{display:block;width:100%;height:100%;padding:0;border:none;background:none;cursor:pointer;position:relative}.uprofile-media-video-badge{position:absolute;bottom:4px;left:4px;width:24px;height:24px;border-radius:50%;background:#00000080;display:flex;align-items:center;justify-content:center}.uprofile-media-video-badge:before{content:"";width:0;height:0;margin-left:2px;border-top:6px solid transparent;border-bottom:6px solid transparent;border-left:9px solid #fff}.uprofile-empty-hint{text-align:center;color:var(--dollars-text-placeholder);font-size:13px;padding:16px 0}#dollars-search-ui{display:flex;flex-direction:column;flex-grow:1;min-height:0;gap:8px;padding:52px 12px 12px;background:var(--dollars-glass-bg);backdrop-filter:var(--dollars-glass-blur);-webkit-backdrop-filter:var(--dollars-glass-blur);position:absolute;inset:0;z-index:100}#dollars-search-ui~.chat-input-container,#dollars-user-profile-panel.visible~.chat-input-container{display:none}#dollars-search-ui .search-panel-row{display:flex;align-items:center;width:100%;opacity:.8}#dollars-search-ui .search-calendar-btn{cursor:pointer;display:flex;align-items:center;justify-content:center;margin-left:5px;width:35px;height:35px;border-radius:50%;background-color:var(--dollars-bg);box-shadow:0 2px 8px #0000001a;border:1px solid var(--dollars-border);color:var(--dollars-text-secondary);flex-shrink:0;transition:all .2s}#dollars-search-ui .search-bar{height:35px;display:flex;align-items:center;min-width:0;position:relative;border-radius:100px;border:1px solid var(--dollars-border);background-color:var(--dollars-bg);transition:all .3s ease-in-out;padding:0 6px;box-shadow:0 2px 8px #0000001a}#dollars-search-ui .search-bar:focus-within{border-color:var(--primary-color);box-shadow:0 0 10px #f0919999}#dollars-search-ui input{flex-grow:1;min-width:0;padding:6px 0;border:none;border-radius:0;background-color:transparent;outline:0;color:var(--dollars-text)}#dollars-search-ui .search-close-btn{flex-shrink:0;cursor:pointer;font-size:20px;color:var(--dollars-text-secondary);align-items:center;opacity:.5;z-index:1;display:flex}#dollars-search-ui .search-icon{flex-shrink:0}#dollars-search-ui input[type=search]::-webkit-search-cancel-button,#dollars-search-ui input[type=search]::-webkit-search-decoration{-webkit-appearance:none;appearance:none;display:none}#dollars-search-results{flex-grow:1;overflow-y:auto;overscroll-behavior:contain}.search-status-msg{text-align:center;padding:20px;color:var(--dollars-text-placeholder)}.search-result-item{display:flex;align-items:flex-start;gap:8px;padding:8px;border-radius:8px;cursor:pointer;transition:background-color .2s}.search-result-item:hover{background-color:var(--dollars-bg-hover)}.search-result-item img{width:24px;height:24px;border-radius:50%}.search-result-item .dollars-search-content{display:flex;flex-direction:column;overflow:hidden}.search-result-item .dollars-search-header{display:flex;align-items:center;gap:6px;font-size:12px}.search-result-item .dollars-search-nickname{font-weight:700;color:var(--dollars-text)}.search-result-item .dollars-search-timestamp{color:var(--dollars-text-secondary)}.search-result-item .dollars-search-message{font-size:13px;color:var(--dollars-text-secondary);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}#dollars-search-ui .search-gallery-btn{cursor:pointer;display:flex;align-items:center;justify-content:center;margin-left:5px;width:35px;height:35px;border-radius:50%;background-color:var(--dollars-bg);box-shadow:0 2px 8px #0000001a;border:1px solid var(--dollars-border);color:var(--dollars-text-secondary);flex-shrink:0;transition:all .2s}#dollars-search-ui .search-gallery-btn:hover{background-color:var(--dollars-bg-hover)}#dollars-search-ui .search-gallery-btn.active{background-color:var(--primary-color);color:#fff;border-color:var(--primary-color)}#dollars-search-ui .search-calendar-btn svg,#dollars-search-ui .search-gallery-btn svg{width:20px;height:20px}#dollars-search-ui .gallery-container{display:flex;flex-direction:column;flex-grow:1;min-height:0;overflow:hidden}#dollars-search-ui .gallery-header{display:flex;align-items:center;justify-content:space-between;margin-bottom:8px}#dollars-search-ui .gallery-title{font-size:14px;font-weight:600;color:var(--dollars-text)}#dollars-search-ui .gallery-close-btn{cursor:pointer;display:flex;align-items:center;justify-content:center;width:28px;height:28px;border-radius:50%;color:var(--dollars-text-secondary);transition:all .2s}#dollars-search-ui .gallery-close-btn:hover{background-color:var(--dollars-bg-hover)}#dollars-search-ui .gallery-close-btn:before{content:"\\d7";font-size:24px;line-height:1}#dollars-search-ui .gallery-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:4px;flex-grow:1;overflow-y:auto;overscroll-behavior:contain;align-content:start}#dollars-search-ui .gallery-item{position:relative;width:100%;padding-bottom:100%;cursor:pointer;overflow:hidden;border-radius:6px;background-color:var(--dollars-bg)}#dollars-search-ui .gallery-item a{position:absolute;top:0;left:0;width:100%;height:100%;display:block}#dollars-search-ui .gallery-item img,#dollars-search-ui .gallery-item video{position:absolute;top:0;left:0;width:100%;height:100%;object-fit:cover}#dollars-search-ui .gallery-item .video-overlay{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background-color:#0000004d;pointer-events:none}#dollars-search-ui .gallery-item .video-overlay:before{content:"";width:0;height:0;margin-left:4px;border-top:16px solid transparent;border-bottom:16px solid transparent;border-left:25px solid #fff;filter:drop-shadow(0 2px 4px rgba(0,0,0,.5))}#dollars-search-ui .gallery-item:hover .video-overlay{background-color:#0006}#dollars-search-ui .gallery-loading{grid-column:1 / -1;text-align:center;padding:20px;color:var(--dollars-text-secondary)}.dollars-tooltip{pointer-events:auto!important}.dollars-tooltip .tooltip-inner a{color:#eee!important;text-decoration:none!important;transition:color .2s;cursor:pointer}.dollars-tooltip .tooltip-inner a:hover{color:#fff!important;border-bottom-color:#fff;text-decoration:none!important}@keyframes dollars-message-in{0%{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}@keyframes dollars-scale-out{0%{opacity:1;transform:scale(1)}to{opacity:0;transform:scale(.95)}}@keyframes dollars-slide-down-out{0%{opacity:1;transform:translateY(0)}to{opacity:0;transform:translateY(10px)}}#dollars-context-menu.closing{animation:dollars-scale-out .15s ease-out forwards;pointer-events:none}#dollars-smiles-floating.closing{animation:dollars-slide-down-out .2s ease-out forwards;pointer-events:none}#dollars-reaction-picker-floating.closing{animation:dollars-scale-out .15s ease-out forwards;pointer-events:none}.chat-message.new-message{animation:dollars-message-in .25s ease-out forwards;transition:none;opacity:0;transform:translateY(8px)}.chat-message.pending.new-message{opacity:.75}.chat-message.pending{opacity:.7;transition:opacity .25s ease-out!important}.chat-message.pending .bubble:after{content:"";position:absolute;right:6px;bottom:4px;width:12px;height:12px;border:2px solid var(--dollars-text-secondary);border-top-color:transparent;border-radius:50%;animation:dollars-spin .7s ease-in-out infinite,dollars-spinner-fade-in .2s ease-out forwards;will-change:transform}@keyframes dollars-spin{0%{transform:rotate(0)}to{transform:rotate(360deg)}}@keyframes dollars-spinner-fade-in{0%{opacity:0;transform:scale(.5) rotate(0)}to{opacity:1;transform:scale(1) rotate(0)}}#dollars-chat-root .likes_grid{opacity:1}#dollars-chat-root .likes_grid .item{gap:3px;background:#ffffffd9}html[data-theme=dark] #dollars-chat-root .likes_grid .item{background:#ffffff26}.reaction-avatars{display:inline-flex;align-items:center;margin-left:3px;flex-shrink:0}.reaction-avatar{width:21px;height:21px;border-radius:50%;margin-left:-5px;object-fit:cover;background-color:var(--dollars-bg);position:relative;flex-shrink:0;transition:transform .15s ease}.reaction-avatar:first-child{margin-left:0}.reaction-item:hover .reaction-avatar{border-color:#369cf8}.reaction-item .num.extra{font-size:10px;margin-left:2px;color:var(--dollars-text-secondary)}.reaction-item:hover .num.extra{color:#fff}@keyframes dollars-stagger-fade{0%{opacity:0;transform:scale(.85)}to{opacity:1;transform:scale(1)}}#dollars-smiles-floating.open .smiley-item,#dollars-reaction-picker-floating.open .smiley-item{animation:dollars-stagger-fade .25s cubic-bezier(.2,.8,.2,1) backwards}@keyframes dollars-menu-cascade{0%{opacity:0;transform:translate(-8px)}to{opacity:1;transform:translate(0)}}#dollars-context-menu.visible .context-menu-items button{animation:dollars-menu-cascade .2s cubic-bezier(.2,.8,.2,1) backwards}#dollars-context-menu.visible .context-menu-items button:nth-child(1){animation-delay:0ms}#dollars-context-menu.visible .context-menu-items button:nth-child(2){animation-delay:25ms}#dollars-context-menu.visible .context-menu-items button:nth-child(3){animation-delay:50ms}#dollars-context-menu.visible .context-menu-items button:nth-child(4){animation-delay:75ms}#dollars-context-menu.visible .context-menu-items button:nth-child(5){animation-delay:.1s}#dollars-context-menu.visible .context-menu-items button:nth-child(6){animation-delay:125ms}#dollars-context-menu.visible .context-menu-items button:nth-child(7){animation-delay:.15s}#dollars-context-menu.visible .context-menu-items button:nth-child(8){animation-delay:175ms}@keyframes dollars-reaction-bounce{0%{opacity:0;transform:scale(.3) translateY(15px)}40%{transform:scale(1.2) translateY(-10px)}65%{transform:scale(.92) translateY(2px)}85%{transform:scale(1.05) translateY(-2px)}to{opacity:1;transform:scale(1) translateY(0)}}#dollars-context-menu.visible .context-menu-reactions .reaction-item{animation:dollars-reaction-bounce .35s cubic-bezier(.34,1.56,.64,1) backwards}#dollars-context-menu.visible .context-menu-reactions .reaction-item:nth-child(1){animation-delay:0ms}#dollars-context-menu.visible .context-menu-reactions .reaction-item:nth-child(2){animation-delay:35ms}#dollars-context-menu.visible .context-menu-reactions .reaction-item:nth-child(3){animation-delay:70ms}#dollars-context-menu.visible .context-menu-reactions .reaction-item:nth-child(4){animation-delay:105ms}#dollars-context-menu.visible .context-menu-reactions .reaction-item:nth-child(5){animation-delay:.14s}#dollars-context-menu.visible .context-menu-reactions .reaction-item:nth-child(6){animation-delay:175ms}#dollars-context-menu.visible .context-menu-reactions .reaction-item:nth-child(7){animation-delay:.21s}.reply-preview.visible{animation:dollars-slide-up .25s cubic-bezier(.2,.8,.2,1)}.search-result-item{animation:dollars-item-slide-in .25s cubic-bezier(.2,.8,.2,1) backwards}.search-result-item:nth-child(1){animation-delay:0ms}.search-result-item:nth-child(2){animation-delay:30ms}.search-result-item:nth-child(3){animation-delay:60ms}.search-result-item:nth-child(4){animation-delay:90ms}.search-result-item:nth-child(5){animation-delay:.12s}.search-result-item:nth-child(6){animation-delay:.15s}.search-result-item:nth-child(7){animation-delay:.18s}.search-result-item:nth-child(8){animation-delay:.21s}.conversation-item{transition:background-color .2s,box-shadow .2s,transform .15s cubic-bezier(.2,.8,.2,1)}.conversation-item:hover{transform:scale(1.02)}.conversation-item:active{transform:scale(.98)}.send-btn:active{transform:scale(.9)!important}.header-btn:active{transform:scale(.92)}@keyframes dollars-date-slide{0%{opacity:0;transform:translate(-50%) translateY(-10px)}to{opacity:1;transform:translate(-50%) translateY(0)}}#dollars-floating-date.visible{animation:dollars-date-slide .3s cubic-bezier(.2,.8,.2,1)}@keyframes dollars-btn-bounce-in{0%{opacity:0;transform:scale(.5)}60%{transform:scale(1.1)}to{opacity:1;transform:scale(1)}}.nav-btn.visible{animation:dollars-btn-bounce-in .3s cubic-bezier(.34,1.56,.64,1)}.dollars-preview-card{animation:dollars-item-slide-in .3s cubic-bezier(.2,.8,.2,1)}.smiley-tab-btn,.reaction-picker-tab-btn{transition:background-color .15s,color .15s,transform .1s}.smiley-tab-btn:active,.reaction-picker-tab-btn:active{transform:scale(.95)}@keyframes dollars-formatter-in{0%{opacity:0;transform:translateY(8px) scale(.9)}to{opacity:1;transform:translateY(0) scale(1)}}#dollars-text-formatter.visible{animation:dollars-formatter-in .2s cubic-bezier(.2,.8,.2,1)}.formatter-btn:active{transform:scale(.9)}@media(prefers-reduced-motion:reduce){*,*:before,*:after{animation-duration:.01ms!important;animation-iteration-count:1!important;transition-duration:.01ms!important}}#unified-notifier{position:fixed;bottom:40px;right:30px;width:223px;z-index:10001;border-radius:15px;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);overflow:hidden;transform:translate(calc(100% + 30px));transition:all .4s ease-in-out;background-color:#fefefee6;color:#000;border:1px solid rgba(0,0,0,.1);box-shadow:0 5px 25px -5px #5050504d;display:flex;flex-direction:column}html[data-theme=dark] #unified-notifier{background-color:#2d2e2fe6;color:#e0e0e1;border:1px solid rgba(255,255,255,.15)}#unified-notifier.show{transform:translate(0)}.un-header{display:flex;justify-content:space-between;align-items:center;padding:0 15px;height:32px;font-size:14px;font-weight:700;color:var(--primary-color);border-bottom:1px solid #eee}html[data-theme=dark] .un-header{border-bottom:1px solid #444}.un-body{padding:0;max-height:400px;overflow-y:auto}.un-item{display:flex;align-items:flex-start;padding:10px 15px}.un-item:not(:last-child){border-bottom:1px solid #eee}html[data-theme=dark] .un-item:not(:last-child){border-bottom:1px solid #444}.un-item .avatarNeue{margin-right:12px;flex-shrink:0;width:40px;height:40px;background-size:cover;border-radius:50%}.un-item .content{flex-grow:1;font-size:13px;overflow:hidden}.un-item .actions{margin-top:8px}.un-action-btn{cursor:pointer;display:inline-block;padding:2px 8px;border-radius:4px;font-size:12px;text-decoration:none!important;transition:background-color .2s}.un-action-btn.btnRedSmall{background-color:var(--primary-color);color:#fff!important}.un-action-btn.btnRedSmall:hover{background-color:#369cf8}.un-action-btn.btnGraySmall{background-color:#eee;color:#666!important}.un-action-btn.btnGraySmall:hover{background-color:#ddd}html[data-theme=dark] .un-action-btn.btnGraySmall{background-color:#444;color:#ccc!important}html[data-theme=dark] .un-action-btn.btnGraySmall:hover{background-color:#555}.un-widget-title{color:#3e3e3e;display:block;margin-bottom:4px}.un-widget-message{color:#666;display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-bottom:4px}html[data-theme=dark] .un-widget-title{color:#e9e9e9}html[data-theme=dark] .un-widget-message{color:#aaa}.un-clear-all{font-size:12px;color:var(--dollars-text-placeholder)!important;text-decoration:none!important}.un-clear-all:hover{color:var(--primary-color)!important}@keyframes dollars-fade-in{0%{opacity:0}to{opacity:1}}.browse-separator{display:block;position:relative;text-align:center;margin:12px -19px;width:calc(100% + 38px);height:30px;line-height:30px;background-color:rgba(var(--primary-color-rgb, 249, 109, 142),.1);z-index:2;pointer-events:none;animation:dollars-fade-in .3s ease}.browse-separator span{font-size:13px;font-weight:600;color:var(--primary-color);background:transparent;border:none;box-shadow:none;padding:0 12px}html[data-theme=dark] .browse-separator{background-color:#f96d8e26}.unread-separator{display:block;position:relative;text-align:center;margin:12px -19px;width:calc(100% + 38px);height:30px;line-height:30px;background-color:#ffffffe6;z-index:2;pointer-events:none;animation:dollars-fade-in .3s ease}.unread-separator span{font-size:13px;font-weight:600;color:var(--primary-color);background:transparent;border:none;box-shadow:none;padding:0 12px}html[data-theme=dark] .unread-separator{background-color:#3c3e40e6}#dollars-card{transition:transform .1s ease-out,box-shadow .3s ease;transform-style:preserve-3d;perspective:1000px;border:1px solid var(--primary-color)!important;background-color:var(--dollars-bg);cursor:pointer}#dollars-card:before{content:"";position:absolute;inset:0;z-index:-1;pointer-events:none;background-image:url(https://lsky.ry.mk/i/2026/01/03/background.svg),linear-gradient(160deg,color-mix(in srgb,var(--primary-color),#a0c4ff 50%),color-mix(in srgb,var(--primary-color),#ffffff 50%),color-mix(in srgb,var(--primary-color),#ffc6ff 50%));background-repeat:repeat,no-repeat;background-position:300px,center;background-size:300px auto,cover;background-blend-mode:overlay,normal;opacity:1;transition:opacity .3s ease,background-position .1s ease-out}html[data-theme=dark] #dollars-card{border:1px solid var(--primary-color);background:initial}html[data-theme=dark] #dollars-card:before{background:linear-gradient(160deg,var(--primary-color) 0%,color-mix(in srgb,var(--primary-color),transparent 40%) 100%);-webkit-mask-image:url(https://lsky.ry.mk/i/2026/01/03/background.svg);mask-image:url(https://lsky.ry.mk/i/2026/01/03/background.svg);mask-repeat:repeat;mask-size:300px;mask-position:300px}#dollars-card:hover{transform:scale(1.02);box-shadow:0 8px 24px #00000026}#dock-chat-link{position:relative}#dock-chat-link .ico_robot_open{background-image:url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M13.05 20.1l-3.05 -6.1l-7 -3.5a.55 .55 0 0 1 0 -1l18 -6.5l-3.312 9.173" /><path d="M19 16l-2 3h4l-2 3" /></svg>')}#dock-chat-link.flashing{animation:dock-flash 1s ease-in-out infinite}@keyframes dock-flash{0%,to{opacity:1}50%{opacity:.3}}.dock-notif-badge{position:absolute;top:-4px;right:-4px;min-width:16px;height:16px;padding:0 4px;border-radius:8px;background-color:#f96d8e;color:#fff;font-size:10px;font-weight:700;line-height:16px;text-align:center;display:none;box-shadow:0 1px 3px #0003}.lb-overlay{position:fixed;inset:0;z-index:var(--dollars-z-index-modal,2000);background:#000000eb;display:flex;align-items:center;justify-content:center;opacity:0;transition:opacity .25s ease;touch-action:none;user-select:none;-webkit-user-select:none}.lb-overlay.lb-visible{opacity:1}.lb-overlay.lb-closing{opacity:0}.lb-img-wrap{position:relative;width:100%;height:100%;display:flex;align-items:center;justify-content:center;overflow:hidden;pointer-events:none}.lb-img{max-width:90vw;max-height:90vh;object-fit:contain;transform-origin:center center;transition:transform .25s ease,opacity .2s ease;will-change:transform;pointer-events:auto;-webkit-user-drag:none;user-select:auto;-webkit-user-select:auto;-webkit-touch-callout:default}.lb-img.lb-dragging{transition:none}.lb-nav,.lb-close{position:absolute;border:none;background:#ffffff26;backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);color:#fff;border-radius:50%;cursor:pointer;display:flex;align-items:center;justify-content:center;z-index:2;transition:background .2s}.lb-nav{top:50%;transform:translateY(-50%);width:44px;height:44px;opacity:.7;transition:background .2s,opacity .2s}.lb-nav:hover,.lb-close:hover{background:#ffffff4d}.lb-nav:hover{opacity:1}.lb-prev{left:12px}.lb-next{right:12px}.lb-close{top:12px;right:12px;width:40px;height:40px;font-size:20px}.lb-close:before{content:"\\d7";font-size:28px;line-height:1}.lb-nav:before{content:"";display:block;width:13px;height:13px;border-left:2px solid currentColor;border-bottom:2px solid currentColor}.lb-prev:before{transform:translate(3px) rotate(45deg)}.lb-next:before{transform:translate(-3px) rotate(-135deg)}.lb-counter{position:absolute;top:16px;left:50%;transform:translate(-50%);color:#ffffffb3;font-size:14px;z-index:2;pointer-events:none}.lb-capsule{position:absolute;bottom:28px;left:50%;transform:translate(-50%);display:flex;align-items:center;gap:8px;max-width:min(76vw,340px);padding:7px 12px 7px 9px;border:1px solid rgba(255,255,255,.14);border-radius:999px;background:#0c0c0e8f;backdrop-filter:blur(12px) saturate(1.1);-webkit-backdrop-filter:blur(12px) saturate(1.1);box-shadow:0 8px 20px #0000003d;color:#fff;cursor:pointer;z-index:2;transition:background-color .18s ease,border-color .18s ease,transform .18s ease;appearance:none;-webkit-appearance:none;font:inherit;text-align:left}.lb-capsule:hover{background:#0c0c0ead;border-color:#fff3;transform:translate(-50%) scale(1.015)}.lb-capsule:active{transform:translate(-50%) scale(.985)}.lb-capsule-avatar{width:28px;height:28px;border-radius:50%;object-fit:cover;border:1px solid rgba(255,255,255,.18);flex-shrink:0}.lb-capsule-info{display:flex;flex-direction:column;min-width:0;gap:2px;line-height:1.1}.lb-capsule-nickname,.lb-capsule-date{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.lb-capsule-nickname{font-size:12px;font-weight:600;letter-spacing:.01em;text-shadow:0 1px 2px rgba(0,0,0,.35)}.lb-capsule-date{font-size:10px;color:#ffffffb8}@media(max-width:600px){.lb-nav{display:none}.lb-img{max-width:100vw;max-height:100vh}.lb-capsule{bottom:18px;max-width:calc(100vw - 28px);padding:7px 11px 7px 9px}}#dollars-chat-root button:focus-visible,#dollars-chat-root a:focus-visible,#dollars-card:focus-visible{outline:2px solid color-mix(in srgb,var(--primary-color),#fff 18%);outline-offset:3px}#dollars-chat-root .action-btn:focus-visible,#dollars-chat-root .send-btn:focus-visible,#dollars-chat-root .nav-btn:focus-visible,#dollars-chat-root .reply-cancel-btn:focus-visible,#dollars-resize-handle:focus-visible{box-shadow:0 0 0 2px var(--dollars-bg),0 0 0 4px color-mix(in srgb,var(--primary-color),transparent 35%)}#dollars-chat-root button:disabled,#dollars-chat-root button[aria-disabled=true]{pointer-events:none}@media(hover:none){#dollars-chat-root .action-btn:hover,#dollars-chat-root .send-btn:hover,#dollars-chat-root .nav-btn:hover,#dollars-card:hover{transform:none}}
`;
    ...
    function App() {
      ...
      return /* @__PURE__ */ _$3("div", { id: "dollars-chat-root", "data-bg-mode": settings.value.backgroundMode }, /* @__PURE__ */ _$3(DockButton, null), /* @__PURE__ */ _$3(NotificationManager, null), hasEverOpened && /* @__PURE__ */ _$3(ErrorBoundary, null, /* @__PURE__ */ _$3(ChatWindow, { skipEntryAnimation }), /* @__PURE__ */ _$3(ContextMenu, null), /* @__PURE__ */ _$3(LightboxViewer, null)));
    }
