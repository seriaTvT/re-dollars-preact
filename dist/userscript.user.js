...
支持的视频格式: MP4, WebM, MOV, MKV 等`);
  ...
  function SearchPanel() {
    ...
    return /* @__PURE__ */ u$2("div", { id: "dollars-search-ui", children: [
      ...
      isGalleryMode.value ? /* @__PURE__ */ u$2(GalleryPanel, { onClose: () => isGalleryMode.value = false }) : /* @__PURE__ */ u$2("div", { id: "dollars-search-results", onScroll: handleScroll, children: [
        ...
        isLoading.value && /* @__PURE__ */ u$2("div", { style: { textAlign: "center", padding: "10px", color: "var(--dollars-text-placeholder)" }, children: "搜索中..." }),
        !isLoading.value && results.value.length === 0 && searchQuery.value && /* @__PURE__ */ u$2("div", { style: { textAlign: "center", padding: "20px", color: "var(--dollars-text-placeholder)" }, children: "未找到相关消息" })
      ] })
    ] });
  }
  ...
  function UserProfilePanel() {
    ...
    const isActive = !loading && profile?.stats?.last_message_time && formatDate(new Date(profile.stats.last_message_time).getTime() / 1e3, "label") === "今天";
          ...
          /* @__PURE__ */ u$2("div", { class: "uprofile-content", children: loading ? /* @__PURE__ */ u$2("div", { class: "uprofile-skeleton-wrap", children: [
            ...
            /* @__PURE__ */ u$2("div", { class: "uprofile-name-section", children: [
              /* @__PURE__ */ u$2("div", { class: "uprofile-nickname", children: [
                ...
                isActive && /* @__PURE__ */ u$2("span", { class: "uprofile-status-dot active" })
              ] }),
              /* @__PURE__ */ u$2("div", { class: "uprofile-username", children: [
                "@",
                profile?.username ?? userId
              ] }),
              lastActiveText && /* @__PURE__ */ u$2("div", { class: "uprofile-last-active", children: isActive ? "在线" : `最近活跃 ${lastActiveText}` })
            ] }),
            profile && /* @__PURE__ */ u$2("div", { class: "uprofile-actions", children: [
              /* @__PURE__ */ u$2("button", { class: "uprofile-action-btn", onClick: handleHistory, children: [
                /* @__PURE__ */ u$2("span", { dangerouslySetInnerHTML: { __html: SVGIcons.history } }),
                "搜索发言"
              ] }),
              /* @__PURE__ */ u$2("button", { class: "uprofile-action-btn", onClick: handleHomepage, children: [
                /* @__PURE__ */ u$2("span", { dangerouslySetInnerHTML: { __html: SVGIcons.home } }),
                "主页"
              ] })
            ] }),
            /* @__PURE__ */ u$2("div", { class: "uprofile-info-section", children: [
              profile?.sign && /* @__PURE__ */ u$2("div", { class: "uprofile-info-row", children: [
                /* @__PURE__ */ u$2("span", { class: "context-icon", dangerouslySetInnerHTML: { __html: SVGIcons.pen } }),
                /* @__PURE__ */ u$2("div", { class: "uprofile-info-content", children: [
                  /* @__PURE__ */ u$2("div", { class: "uprofile-info-label", children: "个性签名" }),
                  /* @__PURE__ */ u$2("div", { class: "uprofile-info-value", children: profile.sign })
                ] })
              ] }),
              profile?.stats && /* @__PURE__ */ u$2("div", { class: "uprofile-info-row", children: [
                /* @__PURE__ */ u$2("span", { class: "context-icon", dangerouslySetInnerHTML: { __html: SVGIcons.reply } }),
                /* @__PURE__ */ u$2("div", { class: "uprofile-info-content", children: [
                  /* @__PURE__ */ u$2("div", { class: "uprofile-info-label", children: "发言统计" }),
                  /* @__PURE__ */ u$2("div", { class: "uprofile-info-value", children: [
                    profile.stats.message_count.toLocaleString(),
                    " 条消息 · 日均 ",
                    profile.stats.average_messages_per_day.toFixed(1)
                  ] })
                ] })
              ] }),
              profile?.stats?.first_message_time && /* @__PURE__ */ u$2("div", { class: "uprofile-info-row", children: [
                /* @__PURE__ */ u$2("span", { class: "context-icon", dangerouslySetInnerHTML: { __html: SVGIcons.calendar } }),
                /* @__PURE__ */ u$2("div", { class: "uprofile-info-content", children: [
            ...
            !mediaLoading && media.length > 0 && /* @__PURE__ */ u$2("div", { class: "uprofile-media-section", children: [
              ...
              /* @__PURE__ */ u$2(
                $,
                {
                  ...
                  children: /* @__PURE__ */ u$2("div", { class: "uprofile-media-grid", children: media.map((item, idx) => /* @__PURE__ */ u$2(
                    "div",
                    {
                      ...
                      children: item.type === "video" ? /* @__PURE__ */ u$2(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ u$2("div", { class: "uprofile-media-video-badge", children: /* @__PURE__ */ u$2("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "white", children: /* @__PURE__ */ u$2("polygon", { points: "5 3 19 12 5 21 5 3" }) }) })
                          ]
                        }
                      ) : /* @__PURE__ */ u$2(ee, { src: item.url, width: 800, height: 600, children: /* @__PURE__ */ u$2(
                        "img",
      ...
      /* @__PURE__ */ u$2(
        "div",
        {
          ...
          children: [
            ...
            unreadJumpList.value.length > 0 && /* @__PURE__ */ u$2("div", { id: "dollars-mention-badge", class: "nav-btn-badge", children: unreadJumpList.value.length > 99 ? "99+" : unreadJumpList.value.length })
          ]
        }
      ),
      /* @__PURE__ */ u$2(
