...
const pmNotifications = d$1([]);
function upsertPmNotification(item) {
...
function clearAllPmNotifications() {
...
function NotificationManager() {
  ...
  const count = notifications.value.length + pmNotifications.value.length;
  if (isChatOpen.value) {
    return null;
  }
  if (settings.value.notificationType === "simple") {
  ...
  return _$3("div", { id: "unified-notifier", class: count > 0 ? "show" : "" }, _$3("div", { class: "un-header" }, _$3("span", null, "通知 (", _$3("span", { class: "un-count" }, count), ")"), _$3(
    ...
    "全部已读"
  )), _$3("div", { class: "un-body" }, _$3("ul", null, pmNotifications.value.map((notif) => _$3(
    PmNotificationItem,
    {
      key: `pm-${notif.id}`,
      notification: notif,
  ...
  )), notifications.value.map((notif) => _$3(
    NotificationItem,
    {
      key: notif.id,
      notification: notif,
...
function PmMessageItem({
  ...
  return _$3(
    ...
    _$3("div", { class: "xw" }, _$3("span", { class: "nickname" }, _$3("a", { href: message.userHref || "#", target: "_blank", rel: "noopener noreferrer" }, nickname)), _$3("div", { class: `bubble${isSticker ? " sticker-mode" : ""}${timestampMode === "trailing" ? " has-trailing-timestamp" : ""}${timestampMode === "stacked" ? " has-stacked-timestamp" : ""}` }, _$3("span", { class: "xz" }, nickname), _$3(
      "div",
      {
        ref: textContentRef,
        class: `xA ${shouldCollapse ? "is-collapsed" : ""}`,
...
function PmConversationView({ id }) {
  ...
  }), !isInitialLoading && detail && detail.messages.length === 0 && _$3("div", { class: "pm-empty-state" }, "这个会话还没有短信")), _$3("div", { class: "xqa dollars-pm-input-container", ref: inputContainerRef }, _$3(TextFormatter, { editorRef: composerRef, inputControllerRef }), _$3(
    SmileyPanel,
    {
      onSelect: (code) => inputControllerRef.current?.insertText(code, { focus: true }),
