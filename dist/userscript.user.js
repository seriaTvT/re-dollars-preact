...
(function () {
    ...
    async function exchangePmLoginToken(token) {
      try {
        ...
        return { status: true, token: String(data.token) };
      } catch (error) {
        return {
          status: false,
          error: error instanceof Error && error.message === "Failed to fetch" ? "auth.ry.mk 暂不可访问，请确认 CORS/Cloudflare 已放行" : "auth.ry.mk 登录失败"
        };
      }
    }
    ...
    function useCollapsibleMessage(textContentRef, content, isDeleted, isSticker) {
...
${content}`;
    ...
    async function submitNewMessage(content, imageMeta, clearInput, clearMediaPreview) {
    ...
    function LightboxViewer() {
      ...
      return /* @__PURE__ */ _$3(
        ...
        total > 1 && /* @__PURE__ */ _$3(k$1, null, /* @__PURE__ */ _$3("button", { class: "lb-nav lb-prev", onClick: () => navigate(-1), "aria-label": "Previous" }), /* @__PURE__ */ _$3("button", { class: "lb-nav lb-next", onClick: () => navigate(1), "aria-label": "Next" })),
